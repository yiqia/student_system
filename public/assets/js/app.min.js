!function (t, e) {
    ...
    "use strict";
    var n = [], i = t.document, s = Object.getPrototypeOf, o = n.slice, r = n.concat, a = n.push, l = n.indexOf, c = {},
        h = c.toString, u = c.hasOwnProperty, d = u.toString, f = d.call(Object), p = {}, m = function (t) {
    ...
    w.fn = w.prototype = {
        ...
        for ("boolean" == typeof r && (c = r, r = arguments[a] || {}, a++), "object" == typeof r || m(r) || (r = {}), a === l && (r = this, a--); a < l; a++) if (null != (t = arguments[a])) for (e in t) n = r[e], r !== (i = t[e]) && (c && i && (w.isPlainObject(i) || (s = Array.isArray(i))) ? (s ? (s = !1, o = n && Array.isArray(n) ? n : []) : o = n && w.isPlainObject(n) ? n : {}, r[e] = w.extend(c, o, i)) : void 0 !== i && (r[e] = i));
        return r
    }, w.extend({
        expando: "jQuery" + (_ + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (t) {
            ...
            var n, i = 0;
            if (k(t)) for (n = t.length; i < n && !1 !== e.call(t[i], i, t[i]); i++) ; else for (i in t) if (!1 === e.call(t[i], i, t[i])) break;
            return t
        }, trim: function (t) {
            ...
            var i, s, o = 0, a = [];
            if (k(t)) for (i = t.length; o < i; o++) null != (s = e(t[o], o, n)) && a.push(s); else for (o in t) null != (s = e(t[o], o, n)) && a.push(s);
            return r.apply([], a)
        }, guid: 1, support: p
    ...
    var C = function (t) {
        var e, n, i, s, o, r, a, l, c, h, u, d, f, p, m, g, v, y, b, _ = "sizzle" + 1 * new Date, w = t.document, D = 0,
            k = 0, C = rt(), x = rt(), T = rt(), S = function (t, e) {
                return t === e && (u = !0), 0
            }, E = {}.hasOwnProperty, M = [], A = M.pop, O = M.push, I = M.push, N = M.slice, P = function (t, e) {
            ...
            H = "\\[" + j + "*(" + Y + ")(?:" + j + "*([*^$|!~]?=)" + j + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + Y + "))|)" + j + "*\\]",
            $ = ":(" + Y + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + H + ")*)|.*)\\)|)",
            R = new RegExp(j + "+", "g"), W = new RegExp("^" + j + "+|((?:^|[^\\\\])(?:\\\\.)*)" + j + "+$", "g"),
            U = new RegExp("^" + j + "*," + j + "*"), F = new RegExp("^" + j + "*([>+~]|" + j + ")" + j + "*"),
            q = new RegExp("=" + j + "*([^\\]'\"]*?)" + j + "*\\]", "g"), V = new RegExp($),
            B = new RegExp("^" + Y + "$"), z = {
                ID: new RegExp("^#(" + Y + ")"),
                CLASS: new RegExp("^\\.(" + Y + ")"),
                TAG: new RegExp("^(" + Y + "|[*])"),
            ...
            }, G = /^(?:input|select|textarea|button)$/i, K = /^h\d$/i, Q = /^[^{]+\{\s*\[native \w/,
            Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, X = /[+~]/,
            J = new RegExp("\\\\([\\da-f]{1,6}" + j + "?|(" + j + ")|.)", "ig"), tt = function (t, e, n) {
                var i = "0x" + e - 65536;
        ...
        try {
            I.apply(M = N.call(w.childNodes), w.childNodes), M[w.childNodes.length].nodeType
        } catch (t) {
            I = {
        ...
        function ot(t, e, i, s) {
            var o, a, c, h, u, p, v, y = e && e.ownerDocument, D = e ? e.nodeType : 9;
            ...
            if (!s && ((e ? e.ownerDocument || e : w) !== f && d(e), e = e || f, m)) {
                if (11 !== D && (u = Z.exec(t))) if (o = u[1]) {
                    ...
                    if ((o = u[3]) && n.getElementsByClassName && e.getElementsByClassName) return I.apply(i, e.getElementsByClassName(o)), i
                }
                if (n.qsa && !T[t + " "] && (!g || !g.test(t))) {
                    if (1 !== D) y = e, v = t; else if ("object" !== e.nodeName.toLowerCase()) {
        ...
        for (e in n = ot.support = {}, o = ot.isXML = function (t) {
            ...
            return r !== f && 9 === r.nodeType && r.documentElement ? (p = (f = r).documentElement, m = !o(f), w !== f && (s = f.defaultView) && s.top !== s && (s.addEventListener ? s.addEventListener("unload", it, !1) : s.attachEvent && s.attachEvent("onunload", it)), n.attributes = lt(function (t) {
            ...
            }), g = g.length && new RegExp(g.join("|")), v = v.length && new RegExp(v.join("|")), e = Q.test(p.compareDocumentPosition), b = e || Q.test(p.contains) ? function (t, e) {
                ...
                if (t === e) return u = !0, 0;
                var n, i = 0, s = t.parentNode, o = e.parentNode, r = [t], a = [e];
            ...
            filter: {
                TAG: function (t) {
                    ...
                    return 1 === i && 0 === s ? function (t) {
                        ...
                        var c, h, u, d, f, p, m = o !== r ? "nextSibling" : "previousSibling", g = e.parentNode,
            ...
            pseudos: {
                not: at(function (t) {
                    ...
                    return B.test(t || "") || ot.error("unsupported lang: " + t), t = t.replace(J, tt).toLowerCase(), function (e) {
                        var n;
                        do {
        ...
        function yt(t, e, n) {
            var i = e.dir, s = e.next, o = s || i, r = n && "parentNode" === o, a = k++;
            return e.first ? function (e, n, s) {
                ...
                } else for (; e = e[i];) if (1 === e.nodeType || r) if (h = (u = e[_] || (e[_] = {}))[e.uniqueID] || (u[e.uniqueID] = {}), s && s === e.nodeName.toLowerCase()) e = e[i] || e; else {
        ...
        function wt(t, e, n, i, s, o) {
            return i && !i[_] && (i = wt(i)), s && !s[_] && (s = wt(s, o)), at(function (o, r, a, l) {
                var c, h, u, d = [], f = [], p = r.length, m = o || function (t, e, n) {
                        for (var i = 0, s = e.length; i < s; i++) ot(t, e[i], n);
                        return n
                    }(e || "*", a.nodeType ? [a] : a, []), g = !t || !o && e ? m : _t(m, d, t, a, l),
                    v = n ? s || (o ? t : p || i) ? [] : r : g;
                ...
                } else v = _t(v === r ? v.splice(p, v.length) : v), s ? s(null, r, v, l) : I.apply(r, v)
            })
        }

        function Dt(t) {
            for (var e, n, s, o = t.length, r = i.relative[t[0].type], a = r || i.relative[" "], l = r ? 1 : 0, h = yt(function (t) {
                return t === e
            }, a, !0), u = yt(function (t) {
                return P(e, t) > -1
                ...
                return e = null, s
            }]; l < o; l++) if (n = i.relative[t[l].type]) d = [yt(bt(d), n)]; else {
                if ((n = i.filter[t[l].type].apply(null, t[l].matches))[_]) {
                    for (s = ++l; s < o && !i.relative[t[s].type]; s++) ;
                    return wt(l > 1 && bt(d), l > 1 && vt(t.slice(0, l - 1).concat({value: " " === t[l - 2].type ? "*" : ""})).replace(W, "$1"), n, l < s && Dt(t.slice(l, s)), s < o && Dt(t = t.slice(s)), s < o && vt(t))
                }
                d.push(n)
            }
            return bt(d)
        ...
        return gt.prototype = i.filters = i.pseudos, i.setFilters = new gt, r = ot.tokenize = function (t, e) {
            ...
            var n, s, o, a, l, h, u = [], p = [], g = T[t + " "];
            if (!g) {
                for (e || (e = r(t)), n = e.length; n--;) (g = Dt(e[n]))[_] ? u.push(g) : p.push(g);
                (g = T(t, (s = p, a = (o = u).length > 0, l = s.length > 0, h = function (t, e, n, r, h) {
                    var u, p, g, v = 0, y = "0", b = t && [], _ = [], w = c, k = t || l && i.find.TAG("*", h),
                        C = D += null == w ? 1 : Math.random() || .1, x = k.length;
                    ...
                    if (v += y, a && y !== v) {
                        ...
                        I.apply(r, _), h && !t && _.length > 0 && v + o.length > 1 && ot.uniqueSort(r)
                    }
                    return h && (D = C, c = w), b
                }, a ? at(h) : h))).selector = t
            }
            ...
            var o, l, c, h, u, d = "function" == typeof t && t, f = !s && r(t = d.selector || t);
            if (n = n || [], 1 === f.length) {
                ...
                for (o = z.needsContext.test(t) ? 0 : l.length; o-- && (c = l[o], !i.relative[h = c.type]);) if ((u = i.find[h]) && (s = u(c.matches[0].replace(J, tt), X.test(l[0].type) && mt(e.parentNode) || e))) {
                    if (l.splice(o, 1), !(t = s.length && vt(l))) return I.apply(n, s), n;
                    break
                }
            }
            return (d || a(t, f))(s, e, !m, n, !e || X.test(t) && mt(e.parentNode) || e), n
        }, n.sortStable = _.split("").sort(S).join("") === _, n.detectDuplicates = !!u, d(), n.sortDetached = lt(function (t) {
    ...
    w.fn.extend({
        has: function (t) {
            ...
            var n, i = 0, s = this.length, o = [], r = "string" != typeof t && w(t);
    ...
    w.Callbacks = function (t) {
        ...
        var i, s, o, r, a = [], l = [], c = -1, h = function () {
            ...
            add: function () {
                ...
                return w.each(arguments, function (t, e) {
                    for (var n; (n = w.inArray(e, a, n)) > -1;) a.splice(n, 1), n <= c && c--
                }), this
            }, has: function (t) {
        ...
        Deferred: function (e) {
                ...
                i = "pending", s = {
                    state: function () {
                            ...
                            return function () {
                                var a = this, l = arguments, c = function () {
                                    ...
                                    if (!(e < o)) {
                                        ...
                                        c = t && ("object" == typeof t || "function" == typeof t) && t.then, m(c) ? s ? c.call(t, r(o, n, Y, s), r(o, n, H, s)) : (o++, c.call(t, r(o, n, Y, s), r(o, n, H, s), r(o, n, Y, n.notifyWith))) : (i !== Y && (a = void 0, l = [t]), (s || n.resolveWith)(a, l))
                                    }
                                }, h = s ? c : function () {
                                    try {
                                        c()
                                    } catch (t) {
                                        w.Deferred.exceptionHook && w.Deferred.exceptionHook(t, h.stackTrace), e + 1 >= o && (i !== H && (a = void 0, l = [t]), n.rejectWith(a, l))
                                    }
                                };
                        ...
                        return w.Deferred(function (t) {
                            n[0][3].add(r(0, t, m(s) ? s : Y, t.notifyWith)), n[1][3].add(r(0, t, m(e) ? e : Y)), n[2][3].add(r(0, t, m(i) ? i : H))
                        }).promise()
                    }, promise: function (t) {
            ...
            var e = arguments.length, n = e, i = Array(n), s = o.call(arguments), r = w.Deferred(), a = function (t) {
                return function (n) {
    ...
    function U() {
        i.removeEventListener("DOMContentLoaded", U), t.removeEventListener("load", U), w.ready()
    }
    ...
    }), w.ready.then = W.then, "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? t.setTimeout(w.ready) : (i.addEventListener("DOMContentLoaded", U), t.addEventListener("load", U));
    var F = function (t, e, n, i, s, o, r) {
        var a = 0, l = t.length, c = null == n;
        if ("object" === b(n)) for (a in s = !0, n) F(t, e, a, n[a], !0, o, r); else if (void 0 !== i && (s = !0, m(i) || (r = !0), c && (r ? (e.call(t, i), e = null) : (c = e, e = function (t, e, n) {
            return c.call(w(t), n)
    ...
    K.uid = 1, K.prototype = {
        cache: function (t) {
            ...
            if ("string" == typeof e) s[z(e)] = n; else for (i in e) s[z(i)] = e[i];
            return s
        }, get: function (t, e) {
    ...
    w.extend({
        ...
        queue: function (t, e) {
            ...
            var n, i = 1, s = w.Deferred(), o = this, r = this.length, a = function () {
                --i || s.resolveWith(o, [o])
            };
    ...
    function rt(t, e, n, i) {
        var s, o, r = 20, a = i ? function () {
                return i.cur()
            } : function () {
                return w.css(t, e, "")
            }, l = a(), c = n && n[3] || (w.cssNumber[e] ? "" : "px"),
            h = (w.cssNumber[e] || "px" !== c && +l) && nt.exec(w.css(t, e));
        if (h && h[3] !== c) {
            for (l /= 2, c = c || h[3], h = +l || 1; r--;) w.style(t, e, h + c), (1 - o) * (1 - (o = a() / l || .5)) <= 0 && (r = 0), h /= o;
    ...
    function yt(t, e, n, i, s) {
        for (var o, r, a, l, c, h, u = e.createDocumentFragment(), d = [], f = 0, p = t.length; f < p; f++) if ((o = t[f]) || 0 === o) if ("object" === b(o)) w.merge(d, o.nodeType ? [o] : o); else if (vt.test(o)) {
        ...
        for (u.textContent = "", f = 0; o = d[f++];) if (i && w.inArray(o, i) > -1) s && s.push(o); else if (c = w.contains(o.ownerDocument, o), r = ft(u.appendChild(o), "script"), c && pt(r), n) for (h = 0; o = r[h++];) ut.test(o.type || "") && n.push(o);
        return u
    }
    ...
    var bt = i.documentElement, _t = /^key/, wt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
        Dt = /^([^.]*)(?:\.(.+)|)/;
    ...
    function Tt(t, e, n, i, s, o) {
        ...
        if (null == i && null == s ? (s = n, i = n = void 0) : null == s && ("string" == typeof n ? (s = i, i = void 0) : (s = i, i = n, n = void 0)), !1 === s) s = Ct; else if (!s) return t;
    ...
    w.event = {
        global: {}, add: function (t, e, n, i, s) {
            ...
            }), c = (e = (e || "").match(j) || [""]).length; c--;) f = m = (a = Dt.exec(e[c]) || [])[1], p = (a[2] || "").split(".").sort(), f && (u = w.event.special[f] || {}, f = (s ? u.delegateType : u.bindType) || f, u = w.event.special[f] || {}, h = w.extend({
                type: f,
                origType: m,
                data: i,
                handler: n,
            ...
            if (g && (l = g.events)) {
                for (c = (e = (e || "").match(j) || [""]).length; c--;) if (f = m = (a = Dt.exec(e[c]) || [])[1], p = (a[2] || "").split(".").sort(), f) {
                    for (u = w.event.special[f] || {}, d = l[f = (i ? u.delegateType : u.bindType) || f] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = o = d.length; o--;) h = d[o], !s && m !== h.origType || n && n.guid !== h.guid || a && !a.test(h.namespace) || i && i !== h.selector && ("**" !== i || !h.selector) || (d.splice(o, 1), h.selector && d.delegateCount--, u.remove && u.remove.call(t, h));
            ...
            var e, n, i, s, o, r, a = w.event.fix(t), l = new Array(arguments.length),
                c = (Q.get(this, "events") || {})[a.type] || [], h = w.event.special[a.type] || {};
            ...
            if (l && c.nodeType && !("click" === t.type && t.button >= 1)) for (; c !== this; c = c.parentNode || this) if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                for (o = [], r = {}, n = 0; n < l; n++) void 0 === r[s = (i = e[n]).selector + " "] && (r[s] = i.needsContext ? w(s, this).index(c) > -1 : w.find(s, this, null, [c]).length), r[s] && o.push(i);
        ...
        t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? kt : Ct, this.target = t.target && 3 === t.target.nodeType ? t.target.parentNode : t.target, this.currentTarget = t.currentTarget, this.relatedTarget = t.relatedTarget) : this.type = t, e && w.extend(this, e), this.timeStamp = t && t.timeStamp || Date.now(), this[w.expando] = !0
    }, w.Event.prototype = {
        constructor: w.Event,
        ...
        w.event.special[t] = {
            delegateType: e, bindType: e, handle: function (t) {
                var n, i = t.relatedTarget, s = t.handleObj;
    ...
    var St = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
        Et = /<script|<style|<link/i, Mt = /checked\s*(?:[^=]|=\s*.checked.)/i,
        At = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ...
    function Pt(t, e) {
        var n, i, s, o, r, a, l, c;
        if (1 === e.nodeType) {
            if (Q.hasData(t) && (o = Q.access(t), r = Q.set(e, o), c = o.events)) for (s in delete r.handle, r.events = {}, c) for (n = 0, i = c[s].length; n < i; n++) w.event.add(e, s, c[s][n]);
    ...
    function Lt(t, e, n, i) {
        e = r.apply([], e);
        var s, o, a, l, c, h, u = 0, d = t.length, f = d - 1, g = e[0], v = m(g);
        if (v || d > 1 && "string" == typeof g && !p.checkClone && Mt.test(g)) return t.each(function (s) {
            var o = t.eq(s);
            v && (e[0] = g.call(this, s, o.html())), Lt(o, e, n, i)
        });
        if (d && (o = (s = yt(e, t[0].ownerDocument, !1, t, i)).firstChild, 1 === s.childNodes.length && (s = o), o || i)) {
            for (l = (a = w.map(ft(s, "script"), It)).length; u < d; u++) c = s, u !== f && (c = w.clone(c, !0, !0), l && w.merge(a, ft(c, "script"))), n.call(t[u], c, u);
            if (l) for (h = a[a.length - 1].ownerDocument, w.map(a, Nt), u = 0; u < l; u++) c = a[u], ut.test(c.type || "") && !Q.access(c, "globalEval") && w.contains(h, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && w._evalUrl(c.src) : y(c.textContent.replace(At, ""), h, c))
        }
        return t
    }

    function jt(t, e, n) {
        for (var i, s = e ? w.filter(e, t) : t, o = 0; null != (i = s[o]); o++) n || 1 !== i.nodeType || w.cleanData(ft(i)), i.parentNode && (n && w.contains(i.ownerDocument, i) && pt(ft(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    ...
    w.extend({
        htmlPrefilter: function (t) {
            ...
            var i, s, o, r, a, l, c, h = t.cloneNode(!0), u = w.contains(t.ownerDocument, t);
            if (!(p.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || w.isXMLDoc(t))) for (r = ft(h), i = 0, s = (o = ft(t)).length; i < s; i++) a = o[i], l = r[i], void 0, "input" === (c = l.nodeName.toLowerCase()) && ct.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e) if (n) for (o = o || ft(t), r = r || ft(h), i = 0, s = o.length; i < s; i++) Pt(o[i], r[i]); else Pt(t, h);
            return (r = ft(h, "script")).length > 0 && pt(r, !u && ft(t, "script")), h
        }, cleanData: function (t) {
            for (var e, n, i, s = w.event.special, o = 0; void 0 !== (n = t[o]); o++) if (G(n)) {
                if (e = n[Q.expando]) {
        ...
        w.fn[t] = function (t) {
            for (var n, i = [], s = w(t), o = s.length - 1, r = 0; r <= o; r++) n = r === o ? this : this.clone(!0), w(s[r])[e](n), a.apply(i, n.get());
            return this.pushStack(i)
        }
    });
    var Yt = new RegExp("^(" + et + ")(?!px)[a-z%]+$", "i"), Ht = function (e) {
    ...
    function Rt(t, e, n) {
        ...
        return (n = n || Ht(t)) && ("" !== (r = n.getPropertyValue(e) || n[e]) || w.contains(t.ownerDocument, t) || (r = w.style(t, e)), !p.pixelBoxStyles() && Yt.test(r) && $t.test(e) && (i = a.width, s = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = n.width, a.width = i, a.minWidth = s, a.maxWidth = o)), void 0 !== r ? r + "" : r
    }
    ...
    !function () {
        function e() {
            if (h) {
                ...
                s = "1%" !== e.top, l = 12 === n(e.marginLeft), h.style.right = "60%", a = 36 === n(e.right), o = 36 === n(e.width), h.style.position = "absolute", r = 36 === h.offsetWidth || "absolute", bt.removeChild(c), h = null
            }
        }
        ...
        var s, o, r, a, l, c = i.createElement("div"), h = i.createElement("div");
    ...
    var Ut = /^(none|table(?!-c[ea]).+)/, Ft = /^--/,
        qt = {position: "absolute", visibility: "hidden", display: "block"},
        Vt = {letterSpacing: "0", fontWeight: "400"}, Bt = ["Webkit", "Moz", "ms"], zt = i.createElement("div").style;
    ...
    function Qt(t, e, n, i, s, o) {
        ...
        for (; r < 4; r += 2) "margin" === n && (l += w.css(t, n + it[r], !0, s)), i ? ("content" === n && (l -= w.css(t, "padding" + it[r], !0, s)), "margin" !== n && (l -= w.css(t, "border" + it[r] + "Width", !0, s))) : (l += w.css(t, "padding" + it[r], !0, s), "padding" !== n ? l += w.css(t, "border" + it[r] + "Width", !0, s) : a += w.css(t, "border" + it[r] + "Width", !0, s));
        return !i && o >= 0 && (l += Math.max(0, Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - o - l - a - .5))), l
    }

    function Zt(t, e, n) {
        var i = Ht(t), s = Rt(t, e, i), o = "border-box" === w.css(t, "boxSizing", !1, i), r = o;
        if (Yt.test(s)) {
            if (!n) return s;
            s = "auto"
        }
        return r = r && (p.boxSizingReliable() || s === t.style[e]), ("auto" === s || !parseFloat(s) && "inline" === w.css(t, "display", !1, i)) && (s = t["offset" + e[0].toUpperCase() + e.slice(1)], r = !0), (s = parseFloat(s) || 0) + Qt(t, e, n || (o ? "border" : "content"), r, i, s) + "px"
    }
    ...
    w.extend({
        ...
        style: function (t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var s, o, r, a = z(e), l = Ft.test(e), c = t.style;
                if (l || (e = Gt(a)), r = w.cssHooks[e] || w.cssHooks[a], void 0 === n) return r && "get" in r && void 0 !== (s = r.get(t, !1, i)) ? s : c[e];
                "string" === (o = typeof n) && (s = nt.exec(n)) && s[1] && (n = rt(t, e, s), o = "number"), null != n && n == n && ("number" === o && (n += s && s[3] || (w.cssNumber[a] ? "" : "px")), p.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (c[e] = "inherit"), r && "set" in r && void 0 === (n = r.set(t, n, i)) || (l ? c.setProperty(e, n) : c[e] = n))
            }
        },
        css: function (t, e, n, i) {
            var s, o, r, a = z(e);
            return Ft.test(e) || (e = Gt(a)), (r = w.cssHooks[e] || w.cssHooks[a]) && "get" in r && (s = r.get(t, !0, n)), void 0 === s && (s = Rt(t, e, i)), "normal" === s && e in Vt && (s = Vt[e]), "" === n || n ? (o = parseFloat(s), !0 === n || isFinite(o) ? o || 0 : s) : s
        }
    }), w.each(["height", "width"], function (t, e) {
        w.cssHooks[e] = {
            get: function (t, n, i) {
                if (n) return !Ut.test(w.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Zt(t, e, i) : ot(t, qt, function () {
                    return Zt(t, e, i)
                })
            }, set: function (t, n, i) {
                var s, o = Ht(t), r = "border-box" === w.css(t, "boxSizing", !1, o), a = i && Qt(t, e, i, r, o);
                return r && p.scrollboxSize() === o.position && (a -= Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - parseFloat(o[e]) - Qt(t, e, "border", !1, o) - .5)), a && (s = nt.exec(n)) && "px" !== (s[3] || "px") && (t.style[e] = n, n = w.css(t, e)), Kt(0, n, a)
            }
        }
        ...
        w.cssHooks[t + e] = {
            expand: function (n) {
                for (var i = 0, s = {}, o = "string" == typeof n ? n.split(" ") : [n]; i < 4; i++) s[t + it[i] + e] = o[i] || o[i - 2] || o[0];
                return s
            }
        ...
        constructor: Xt, init: function (t, e, n, i, s, o) {
    ...
    var Jt, te, ee, ne, ie = /^(?:toggle|show|hide)$/, se = /queueHooks$/;
    ...
    function ce(t, e, n) {
        var i, s, o = 0, r = ce.prefilters.length, a = w.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (s) return !1;
        ...
        for (!function (t, e) {
            var n, i, s, o, r;
            for (n in t) if (s = e[i = z(n)], o = t[n], Array.isArray(o) && (s = o[1], o = t[n] = o[0]), n !== i && (t[i] = o, delete t[n]), (r = w.cssHooks[i]) && "expand" in r) for (n in o = r.expand(o), delete t[i], o) n in t || (t[n] = o[n], e[n] = s); else e[i] = s
        }(h, c.opts.specialEasing); o < r; o++) if (i = ce.prefilters[o].call(c, t, h, c.opts)) return m(i.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return w.map(h, le, c), m(c.opts.start) && c.opts.start.call(t, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), w.fx.timer(w.extend(l, {
            elem: t,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    w.Animation = w.extend(ce, {
        tweeners: {
            ...
            var i, s, o, r, a, l, c, h, u = "width" in e || "height" in e, d = this, f = {}, p = t.style,
                m = t.nodeType && st(t), g = Q.get(t, "fxshow");
            ...
            })), l = !1, f) l || (g ? "hidden" in g && (m = g.hidden) : g = Q.access(t, "fxshow", {display: c}), o && (g.hidden = !m), m && lt([t], !0), d.done(function () {
        ...
        fadeTo: function (t, e, n, i) {
            ...
            var s = w.isEmptyObject(t), o = w.speed(e, n, i), r = function () {
            ...
            return "string" != typeof t && (n = e, e = t, t = void 0), e && !1 !== t && this.queue(t || "fx", []), this.each(function () {
                var e = !0, s = null != t && t + "queueHooks", o = w.timers, r = Q.get(this);
                if (s) r[s] && r[s].stop && i(r[s]); else for (s in r) r[s] && r[s].stop && se.test(s) && i(r[s]);
                for (s = o.length; s--;) o[s].elem !== this || null != t && o[s].queue !== t || (o[s].anim.stop(n), e = !1, o.splice(s, 1));
                !e && n || w.dequeue(this, t)
            })
        }, finish: function (t) {
            return !1 !== t && (t = t || "fx"), this.each(function () {
                var e, n = Q.get(this), i = n[t + "queue"], s = n[t + "queueHooks"], o = w.timers, r = i ? i.length : 0;
    ...
    }, ee = i.createElement("input"), ne = i.createElement("select").appendChild(i.createElement("option")), ee.type = "checkbox", p.checkOn = "" !== ee.value, p.optSelected = ne.selected, (ee = i.createElement("input")).value = "t", ee.type = "radio", p.radioValue = "t" === ee.value;
    ...
    w.fn.extend({
        ...
        ue[e] = function (t, e, i) {
            ...
            return i || (o = ue[r], ue[r] = s, s = null != n(t, e, i) ? r : null, ue[r] = o), s
        }
    });
    ...
    w.fn.extend({
        ...
        addClass: function (t) {
            ...
            return "boolean" == typeof e && i ? e ? this.addClass(t) : this.removeClass(t) : m(t) ? this.each(function (n) {
                ...
                var e, s, o, r;
                if (i) for (s = 0, o = w(this), r = ge(t); e = r[s++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else void 0 !== t && "boolean" !== n || ((e = me(this)) && Q.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Q.get(this, "__className__") || ""))
            })
        }, hasClass: function (t) {
            var e, n, i = 0;
    ...
    w.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (t) {
                    var e, n, i, s = t.options, o = t.selectedIndex, r = "select-one" === t.type, a = r ? null : [],
                        l = r ? o + 1 : s.length;
                    ...
                    for (var n, i, s = t.options, o = w.makeArray(e), r = s.length; r--;) ((i = s[r]).selected = w.inArray(w.valHooks.option.get(i), o) > -1) && (n = !0);
    ...
    w.extend(w.event, {
        trigger: function (e, n, s, o) {
            var r, a, l, c, h, d, f, p, v = [s || i], y = u.call(e, "type") ? e.type : e,
            ...
            if (a = p = l = s = s || i, 3 !== s.nodeType && 8 !== s.nodeType && !ye.test(y + w.event.triggered) && (y.indexOf(".") > -1 && (y = (b = y.split(".")).shift(), b.sort()), h = y.indexOf(":") < 0 && "on" + y, (e = e[w.expando] ? e : new w.Event(y, "object" == typeof e && e)).isTrigger = o ? 2 : 3, e.namespace = b.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = s), n = null == n ? [e] : w.makeArray(n, [e]), f = w.event.special[y] || {}, o || !f.trigger || !1 !== f.trigger.apply(s, n))) {
                if (!o && !f.noBubble && !g(s)) {
                    for (c = f.delegateType || y, ye.test(c + y) || (a = a.parentNode); a; a = a.parentNode) v.push(a), l = a;
                    l === (s.ownerDocument || i) && v.push(l.defaultView || l.parentWindow || t)
                }
                for (r = 0; (a = v[r++]) && !e.isPropagationStopped();) p = a, e.type = r > 1 ? c : f.bindType || y, (d = (Q.get(a, "events") || {})[e.type] && Q.get(a, "handle")) && d.apply(a, n), (d = h && a[h]) && d.apply && G(a) && (e.result = d.apply(a, n), !1 === e.result && e.preventDefault());
                return e.type = y, o || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(v.pop(), n) || !G(s) || h && m(s[y]) && !g(s) && ((l = s[h]) && (s[h] = null), w.event.triggered = y, e.isPropagationStopped() && p.addEventListener(y, be), s[y](), e.isPropagationStopped() && p.removeEventListener(y, be), w.event.triggered = void 0, l && (s[h] = l)), e.result
            }
        ...
        w.event.special[e] = {
            setup: function () {
                var i = this.ownerDocument || this, s = Q.access(i, e);
                s || i.addEventListener(t, n, !0), Q.access(i, e, (s || 0) + 1)
            }, teardown: function () {
                var i = this.ownerDocument || this, s = Q.access(i, e) - 1;
                s ? Q.access(i, e, s) : (i.removeEventListener(t, n, !0), Q.remove(i, e))
            }
        }
    });
    var _e = t.location, we = Date.now(), De = /\?/;
    ...
    function Se(t, e, n, i) {
        ...
        }); else if (n || "object" !== b(e)) i(t, e); else for (s in e) Se(t + "[" + s + "]", e[s], n, i)
    }
    ...
    var Ee = /%20/g, Me = /#.*$/, Ae = /([?&])_=[^&]*/, Oe = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ie = /^(?:GET|HEAD)$/,
        Ne = /^\/\//, Pe = {}, Le = {}, je = "*/".concat("*"), Ye = i.createElement("a");

    function He(t) {
        return function (e, n) {
            "string" != typeof e && (n = e, e = "*");
            var i, s = 0, o = e.toLowerCase().match(j) || [];
    ...
    Ye.href = _e.href, w.extend({
        ...
        ajax: function (e, n) {
            ...
            var s, o, r, a, l, c, h, u, d, f, p = w.ajaxSetup({}, n), m = p.context || p,
                g = p.context && (m.nodeType || m.jquery) ? w(m) : w.event, v = w.Deferred(),
                y = w.Callbacks("once memory"), b = p.statusCode || {}, _ = {}, D = {}, k = "canceled", C = {
                    readyState: 0, getResponseHeader: function (t) {
                        ...
                        return null == h && (t = D[t.toLowerCase()] = D[t.toLowerCase()] || t, _[t] = e), this
    ...
    var We = {0: 200, 1223: 204}, Ue = w.ajaxSettings.xhr();
    p.cors = !!Ue && "withCredentials" in Ue, p.ajax = Ue = !!Ue, w.ajaxTransport(function (e) {
        ...
        if (p.cors || Ue && !e.crossDomain) return {
            send: function (s, o) {
                ...
                n = function (t) {
                    return function () {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(We[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                    }
        ...
        if (t.crossDomain) return {
            send: function (s, o) {
                e = w("<script>").prop({charset: t.scriptCharset, src: t.url}).on("load error", n = function (t) {
    ...
    w.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return s = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Ve, "$1" + s) : !1 !== e.jsonp && (e.url += (De.test(e.url) ? "&" : "?") + e.jsonp + "=" + s), e.converters["script json"] = function () {
            return r || w.error(s + " was not called"), r[0]
        }, e.dataTypes[0] = "json", o = t[s], t[s] = function () {
            r = arguments
        }, i.always(function () {
            void 0 === o ? w(t).removeProp(s) : t[s] = o, e[s] && (e.jsonpCallback = n.jsonpCallback, qe.push(s)), r && m(o) && o(r[0]), r = o = void 0
        }), "script"
    }), p.createHTMLDocument = ((Fe = i.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Fe.childNodes.length), w.parseHTML = function (t, e, n) {
        ...
        return a > -1 && (i = pe(t.slice(a)), t = t.slice(0, a)), m(e) ? (n = e, e = void 0) : e && "object" == typeof e && (s = "POST"), r.length > 0 && w.ajax({
            url: t,
            type: s || "GET",
            dataType: "html",
            data: e
        ...
        setOffset: function (t, e, n) {
            var i, s, o, r, a, l, c = w.css(t, "position"), h = w(t), u = {};
            "static" === c && (t.style.position = "relative"), a = h.offset(), o = w.css(t, "top"), l = w.css(t, "left"), ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1 ? (r = (i = h.position()).top, s = i.left) : (r = parseFloat(o) || 0, s = parseFloat(l) || 0), m(e) && (e = e.call(t, n, w.extend({}, a))), null != e.top && (u.top = e.top - a.top + r), null != e.left && (u.left = e.left - a.left + s), "using" in e ? e.using.call(t, u) : h.css(u)
        }
    }, w.fn.extend({
        offset: function (t) {
            ...
            if (this[0]) {
                var t, e, n, i = this[0], s = {top: 0, left: 0};
        ...
        var n, i, s;
        if ("string" == typeof e && (n = t[e], e = t, t = n), m(t)) return i = o.call(arguments, 2), (s = function () {
            return t.apply(e || this, i.concat(o.call(arguments)))
        }).guid = t.guid = t.guid || w.guid++, s
    }, w.holdReady = function (t) {
        t ? w.readyWait++ : w.ready(!0)
    }, w.isArray = Array.isArray, w.parseJSON = JSON.parse, w.nodeName = E, w.isFunction = m, w.isWindow = g, w.camelCase = z, w.type = b, w.now = Date.now, w.isNumeric = function (t) {
        var e = w.type(t);
    ...
    return w.noConflict = function (e) {
        return t.$ === w && (t.$ = ze), e && t.jQuery === w && (t.jQuery = Be), w
    }, e || (t.jQuery = t.$ = w), w
}), function (t, e) {
    ...
    function s(t) {
        for (var e = 1; e < arguments.length; e++) {
            ...
            "function" == typeof Object.getOwnPropertySymbols && (i = i.concat(Object.getOwnPropertySymbols(n).filter(function (t) {
                ...
                var i, s, o;
                i = t, s = e, o = n[e], s in i ? Object.defineProperty(i, s, {
                    value: o,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
    ...
    var a = {
        TRANSITION_END: "bsTransitionEnd", getUID: function (t) {
            ...
            if (!t) return 0;
            var n = e(t).css("transition-duration"), i = e(t).css("transition-delay"), s = parseFloat(n),
                o = parseFloat(i);
    ...
    (e = e && e.hasOwnProperty("default") ? e.default : e).fn.emulateTransitionEnd = r, e.event.special[a.TRANSITION_END] = {
        bindType: o,
        delegateType: o,
        handle: function (t) {
    ...
    var l = "alert", c = "bs.alert", h = "." + c, u = e.fn[l],
        d = {CLOSE: "close" + h, CLOSED: "closed" + h, CLICK_DATA_API: "click" + h + ".data-api"}, f = "alert",
        p = "fade", m = "show", g = function () {
            function t(t) {
                this._element = t
            }
            ...
            return n.close = function (t) {
                ...
                return this.each(function () {
                    var i = e(this), s = i.data(c);
                    s || (s = new t(this), i.data(c, s)), "close" === n && s[n](this)
                })
    ...
    e(document).on(d.CLICK_DATA_API, '[data-dismiss="alert"]', g._handleDismiss(new g)), e.fn[l] = g._jQueryInterface, e.fn[l].Constructor = g, e.fn[l].noConflict = function () {
        return e.fn[l] = u, g._jQueryInterface
    };
    var v = "button", y = "bs.button", b = "." + y, _ = ".data-api", w = e.fn[v], D = "active", k = "btn", C = "focus",
        x = '[data-toggle^="button"]', T = '[data-toggle="buttons"]', S = 'input:not([type="hidden"])', E = ".active",
        M = ".btn", A = {CLICK_DATA_API: "click" + b + _, FOCUS_BLUR_DATA_API: "focus" + b + _ + " blur" + b + _},
        O = function () {
            function t(t) {
                this._element = t
            }
            ...
            return n.toggle = function () {
                var t = !0, n = !0, i = e(this._element).closest(T)[0];
                if (i) {
                    var s = this._element.querySelector(S);
                    if (s) {
                        if ("radio" === s.type) if (s.checked && this._element.classList.contains(D)) t = !1; else {
                        ...
                        if (t) {
                            ...
                            s.checked = !this._element.classList.contains(D), e(s).trigger("change")
                        }
                        s.focus(), n = !1
                    }
                }
                n && this._element.setAttribute("aria-pressed", !this._element.classList.contains(D)), t && e(this._element).toggleClass(D)
            }, n.dispose = function () {
                e.removeData(this._element, y), this._element = null
            }, t._jQueryInterface = function (n) {
                return this.each(function () {
                    var i = e(this).data(y);
                    i || (i = new t(this), e(this).data(y, i)), "toggle" === n && i[n]()
                })
            }, i(t, null, [{
                key: "VERSION", get: function () {
                    return "4.3.1"
    ...
    e(document).on(A.CLICK_DATA_API, x, function (t) {
        t.preventDefault();
        var n = t.target;
        e(n).hasClass(k) || (n = e(n).closest(M)), O._jQueryInterface.call(e(n), "toggle")
    }).on(A.FOCUS_BLUR_DATA_API, x, function (t) {
        var n = e(t.target).closest(M)[0];
        e(n).toggleClass(C, /^focus(in)?$/.test(t.type))
    }), e.fn[v] = O._jQueryInterface, e.fn[v].Constructor = O, e.fn[v].noConflict = function () {
        return e.fn[v] = w, O._jQueryInterface
    };
    var I = "carousel", N = "bs.carousel", P = "." + N, L = ".data-api", j = e.fn[I],
        Y = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, H = {
        ...
        }, q = "carousel", V = "active", B = "slide", z = "carousel-item-right", G = "carousel-item-left",
        K = "carousel-item-next", Q = "carousel-item-prev", Z = "pointer-event", X = {
            ACTIVE: ".active",
            ...
            return n.next = function () {
                ...
                t || (this._isPaused = !0), this._element.querySelector(X.NEXT_PREV) && (a.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, n.cycle = function (t) {
                ...
                e(this._element).off(P), e.removeData(this._element, N), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, n._getConfig = function (t) {
                return t = s({}, Y, t), a.typeCheckConfig(I, t, H), t
                ...
                if (this._touchSupported) {
                    ...
                    e(this._element.querySelectorAll(X.ITEM_IMG)).on(F.DRAG_START, function (t) {
                        return t.preventDefault()
                    }), this._pointerEvent ? (e(this._element).on(F.POINTERDOWN, function (t) {
                        return n(t)
                    }), e(this._element).on(F.POINTERUP, function (t) {
                        return i(t)
                    }), this._element.classList.add(Z)) : (e(this._element).on(F.TOUCHSTART, function (t) {
                        return n(t)
                    }), e(this._element).on(F.TOUCHMOVE, function (e) {
                        var n;
                        (n = e).originalEvent.touches && n.originalEvent.touches.length > 1 ? t.touchDeltaX = 0 : t.touchDeltaX = n.originalEvent.touches[0].clientX - t.touchStartX
                ...
                var n = t === $, i = t === R, s = this._getItemIndex(e), o = this._items.length - 1;
                if ((i && 0 === s || n && s === o) && !this._config.wrap) return e;
                var r = (s + (t === R ? -1 : 1)) % this._items.length;
                return -1 === r ? this._items[this._items.length - 1] : this._items[r]
            }, n._triggerSlideEvent = function (t, n) {
                var i = this._getItemIndex(t), s = this._getItemIndex(this._element.querySelector(X.ACTIVE_ITEM)),
                    o = e.Event(F.SLIDE, {relatedTarget: t, direction: n, from: s, to: i});
                ...
                var i, s, o, r = this, l = this._element.querySelector(X.ACTIVE_ITEM), c = this._getItemIndex(l),
                    h = n || l && this._getItemByDirection(t, l), u = this._getItemIndex(h), d = Boolean(this._interval);
                if (t === $ ? (i = G, s = K, o = W) : (i = z, s = Q, o = U), h && e(h).hasClass(V)) this._isSliding = !1; else if (!this._triggerSlideEvent(h, o).isDefaultPrevented() && l && h) {
                    this._isSliding = !0, d && this.pause(), this._setActiveIndicatorElement(h);
                    var f = e.Event(F.SLID, {relatedTarget: h, direction: o, from: c, to: u});
                    if (e(this._element).hasClass(B)) {
                        e(h).addClass(s), a.reflow(h), e(l).addClass(i), e(h).addClass(i);
                        ...
                        e(l).one(a.TRANSITION_END, function () {
                            e(h).removeClass(i + " " + s).addClass(V), e(l).removeClass(V + " " + s + " " + i), r._isSliding = !1, setTimeout(function () {
                                return e(r._element).trigger(f)
                            }, 0)
                        }).emulateTransitionEnd(m)
                    } else e(l).removeClass(V), e(h).addClass(V), this._isSliding = !1, e(this._element).trigger(f);
                    d && this.cycle()
                }
            }, t._jQueryInterface = function (n) {
                return this.each(function () {
                    var i = e(this).data(N), o = s({}, Y, e(this).data());
                    "object" == typeof n && (o = s({}, o, n));
                    var r = "string" == typeof n ? n : o.slide;
                    if (i || (i = new t(this, o), e(this).data(N, i)), "number" == typeof n) i.to(n); else if ("string" == typeof r) {
                ...
                if (i) {
                    ...
                    if (o && e(o).hasClass(q)) {
                        ...
                        l && (r.interval = !1), t._jQueryInterface.call(e(o), r), l && e(o).data(N).to(l), n.preventDefault()
                    }
                }
            }, i(t, null, [{
                key: "VERSION", get: function () {
    ...
    e(document).on(F.CLICK_DATA_API, X.DATA_SLIDE, tt._dataApiClickHandler), e(window).on(F.LOAD_DATA_API, function () {
        for (var t = [].slice.call(document.querySelectorAll(X.DATA_RIDE)), n = 0, i = t.length; n < i; n++) {
            var s = e(t[n]);
            tt._jQueryInterface.call(s, s.data())
        }
    }), e.fn[I] = tt._jQueryInterface, e.fn[I].Constructor = tt, e.fn[I].noConflict = function () {
        return e.fn[I] = j, tt._jQueryInterface
    };
    var et = "collapse", nt = "bs.collapse", it = "." + nt, st = e.fn[et], ot = {toggle: !0, parent: ""},
        rt = {toggle: "boolean", parent: "(string|element)"}, at = {
            SHOW: "show" + it,
            SHOWN: "shown" + it,
            HIDE: "hide" + it,
            HIDDEN: "hidden" + it,
            CLICK_DATA_API: "click" + it + ".data-api"
        }, lt = "show", ct = "collapse", ht = "collapsing", ut = "collapsed", dt = "width", ft = "height",
        pt = {ACTIVES: ".show, .collapsing", DATA_TOGGLE: '[data-toggle="collapse"]'}, mt = function () {
            function t(t, e) {
                ...
                for (var n = [].slice.call(document.querySelectorAll(pt.DATA_TOGGLE)), i = 0, s = n.length; i < s; i++) {
                    var o = n[i], r = a.getSelectorFromElement(o),
            ...
            return n.toggle = function () {
                ...
                if (!this._isTransitioning && !e(this._element).hasClass(lt) && (this._parent && 0 === (n = [].slice.call(this._parent.querySelectorAll(pt.ACTIVES)).filter(function (t) {
                    ...
                    if (e(this._element).trigger(o), !o.isDefaultPrevented()) {
                        ...
                        e(this._element).removeClass(ct).addClass(ht), this._element.style[r] = 0, this._triggerArray.length && e(this._triggerArray).removeClass(ut).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var l = "scroll" + (r[0].toUpperCase() + r.slice(1)),
                            c = a.getTransitionDurationFromElement(this._element);
                        e(this._element).one(a.TRANSITION_END, function () {
                            e(s._element).removeClass(ht).addClass(ct).addClass(lt), s._element.style[r] = "", s.setTransitioning(!1), e(s._element).trigger(at.SHOWN)
                ...
                if (!this._isTransitioning && e(this._element).hasClass(lt)) {
                    ...
                    if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
                        ...
                        this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", a.reflow(this._element), e(this._element).addClass(ht).removeClass(ct).removeClass(lt);
                        var s = this._triggerArray.length;
                        if (s > 0) for (var o = 0; o < s; o++) {
                            var r = this._triggerArray[o], l = a.getSelectorFromElement(r);
                        ...
                        e(this._element).one(a.TRANSITION_END, function () {
                            t.setTransitioning(!1), e(t._element).removeClass(ht).addClass(ct).trigger(at.HIDDEN)
                ...
                return (t = s({}, ot, t)).toggle = Boolean(t.toggle), a.typeCheckConfig(et, t, rt), t
                ...
                return this.each(function () {
                    var i = e(this), o = i.data(nt), r = s({}, ot, i.data(), "object" == typeof n && n ? n : {});
    ...
    e(document).on(at.CLICK_DATA_API, pt.DATA_TOGGLE, function (t) {
        "A" === t.currentTarget.tagName && t.preventDefault();
        var n = e(this), i = a.getSelectorFromElement(this), s = [].slice.call(document.querySelectorAll(i));
        e(s).each(function () {
            var t = e(this), i = t.data(nt) ? "toggle" : n.data();
            mt._jQueryInterface.call(t, i)
        })
    }), e.fn[et] = mt._jQueryInterface, e.fn[et].Constructor = mt, e.fn[et].noConflict = function () {
        return e.fn[et] = st, mt._jQueryInterface
    };
    for (var gt = "undefined" != typeof window && "undefined" != typeof document, vt = ["Edge", "Trident", "Firefox"], yt = 0, bt = 0; bt < vt.length; bt += 1) if (gt && navigator.userAgent.indexOf(vt[bt]) >= 0) {
        yt = 1;
        break
    }
    ...
    function Ct(t) {
        ...
        var e = Dt(t), n = e.overflow, i = e.overflowX, s = e.overflowY;
    ...
    function At(t, e) {
        ...
        var n = t.compareDocumentPosition(e) & Node.DOCUMENT_POSITION_FOLLOWING, i = n ? t : e, s = n ? e : t,
    ...
    function Pt(t) {
        var e = t.body, n = t.documentElement, i = St(10) && getComputedStyle(n);
    ...
    function Rt(t) {
        ...
        var s = {left: e.left, top: e.top, width: e.right - e.left, height: e.bottom - e.top},
            o = "HTML" === t.nodeName ? Pt(t.ownerDocument) : {}, r = o.width || t.clientWidth || s.right - s.left,
            a = o.height || t.clientHeight || s.bottom - s.top, l = t.offsetWidth - r, c = t.offsetHeight - a;
        if (l || c) {
            var h = Dt(t);
            l -= It(h, "x"), c -= It(h, "y"), s.width -= l, s.height -= c
        }
        return $t(s)
    }

    function Wt(t, e) {
        var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = St(10), s = "HTML" === e.nodeName,
            o = Rt(t), r = Rt(e), a = Ct(t), l = Dt(e), c = parseFloat(l.borderTopWidth, 10),
            h = parseFloat(l.borderLeftWidth, 10);
        n && s && (r.top = Math.max(r.top, 0), r.left = Math.max(r.left, 0));
        var u = $t({top: o.top - r.top - c, left: o.left - r.left - h, width: o.width, height: o.height});
        ...
        return (i && !n ? e.contains(a) : e === a && "BODY" !== a.nodeName) && (u = function (t, e) {
            var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = Ot(e, "top"),
                s = Ot(e, "left"), o = n ? -1 : 1;
    ...
    function Ft(t, e, n, i) {
        ...
        if ("viewport" === i) o = function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                n = t.ownerDocument.documentElement, i = Wt(t, n), s = Math.max(n.clientWidth, window.innerWidth || 0),
                o = Math.max(n.clientHeight, window.innerHeight || 0), r = e ? 0 : Ot(n), a = e ? 0 : Ot(n, "left");
            return $t({top: r - i.top + i.marginTop, left: a - i.left + i.marginLeft, width: s, height: o})
        }(r, s); else {
            var a = void 0;
            ...
            if ("HTML" !== a.nodeName || function t(e) {
                ...
                var c = Pt(t.ownerDocument), h = c.height, u = c.width;
    ...
    function qt(t, e, n, i, s) {
        ...
        var r = Ft(n, i, o, s), a = {
            ...
            return Ht({key: t}, a[t], {area: (e = a[t], e.width * e.height)});
            var e
        }).sort(function (t, e) {
    ...
    function Gt(t, e, n) {
        n = n.split("-")[0];
        var i = Bt(t), s = {width: i.width, height: i.height}, o = -1 !== ["right", "left"].indexOf(n),
            r = o ? "top" : "left", a = o ? "left" : "top", l = o ? "height" : "width", c = o ? "width" : "height";
        return s[r] = e[r] + e[l] / 2 - i[l] / 2, s[a] = n === a ? e[a] - i[c] : e[zt(a)], s
    }
    ...
    function te(t, e, n, i) {
        ...
        return function t(e, n, i, s) {
            ...
            r.addEventListener(n, i, {passive: !0}), o || t(Ct(r.parentNode), n, i, s), s.push(r)
    ...
    function ie(t, e) {
        Object.keys(e).forEach(function (n) {
            var i = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && ne(e[n]) && (i = "px"), t.style[n] = e[n] + i
        })
    }
    ...
    function le(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = ae.indexOf(t),
    ...
    function he(t, e, n, i) {
        var s = [0, 0], o = -1 !== ["right", "left"].indexOf(i), r = t.split(/(\+|\-)/).map(function (t) {
            return t.trim()
        }), a = r.indexOf(Kt(r, function (t) {
            return -1 !== t.search(/,|\s/)
        }));
        ...
        return (c = c.map(function (t, i) {
            var s = (1 === i ? !o : o) ? "height" : "width", r = !1;
    ...
    var ue = {
        placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
            ...
            shift: {
                order: 100, enabled: !0, fn: function (t) {
                    ...
                    if (i) {
                        var s = t.offsets, o = s.reference, r = s.popper, a = -1 !== ["bottom", "top"].indexOf(n),
                            l = a ? "left" : "top", c = a ? "width" : "height",
                            h = {start: Yt({}, l, o[l]), end: Yt({}, l, o[l] + o[c] - r[c])};
                        t.offsets.popper = Ht({}, r, h[i])
                    }
                    return t
                }
            }, offset: {
                order: 200, enabled: !0, fn: function (t, e) {
                    var n = e.offset, i = t.placement, s = t.offsets, o = s.popper, r = s.reference,
                        a = i.split("-")[0], l = void 0;
                    return l = ne(+n) ? [+n, 0] : he(n, o, r, a), "left" === a ? (o.top += l[0], o.left -= l[1]) : "right" === a ? (o.top += l[0], o.left += l[1]) : "top" === a ? (o.left += l[0], o.top -= l[1]) : "bottom" === a && (o.left += l[0], o.top += l[1]), t.popper = o, t
                }, offset: 0
            }, preventOverflow: {
                order: 300, enabled: !0, fn: function (t, e) {
                    var n = e.boundariesElement || Et(t.instance.popper);
                    t.instance.reference === n && (n = Et(n));
                    var i = Xt("transform"), s = t.instance.popper.style, o = s.top, r = s.left, a = s[i];
                    s.top = "", s.left = "", s[i] = "";
                    var l = Ft(t.instance.popper, t.instance.reference, e.padding, n, t.positionFixed);
                    s.top = o, s.left = r, s[i] = a, e.boundaries = l;
                ...
                order: 400, enabled: !0, fn: function (t) {
                    var e = t.offsets, n = e.popper, i = e.reference, s = t.placement.split("-")[0], o = Math.floor,
                ...
                order: 500, enabled: !0, fn: function (t, e) {
                    ...
                    var s = t.placement.split("-")[0], o = t.offsets, r = o.popper, a = o.reference,
                        l = -1 !== ["left", "right"].indexOf(s), c = l ? "height" : "width", h = l ? "Top" : "Left",
                        u = h.toLowerCase(), d = l ? "left" : "top", f = l ? "bottom" : "right", p = Bt(i)[c];
                    a[f] - p < r[u] && (t.offsets.popper[u] -= r[u] - (a[f] - p)), a[u] + p > r[f] && (t.offsets.popper[u] += a[u] + p - r[f]), t.offsets.popper = $t(t.offsets.popper);
                    var m = a[u] + a[c] / 2 - p / 2, g = Dt(t.instance.popper), v = parseFloat(g["margin" + h], 10),
                        y = parseFloat(g["border" + h + "Width"], 10), b = m - t.offsets.popper[u] - v - y;
                    return b = Math.max(Math.min(r[c] - p, b), 0), t.arrowElement = i, t.offsets.arrow = (Yt(n = {}, u, Math.round(b)), Yt(n, d, ""), n), t
                }, element: "[x-arrow]"
            }, flip: {
                order: 600, enabled: !0, fn: function (t, e) {
                    ...
                    var n = Ft(t.instance.popper, t.instance.reference, e.padding, e.boundariesElement, t.positionFixed),
                        i = t.placement.split("-")[0], s = zt(i), o = t.placement.split("-")[1] || "", r = [];
                    switch (e.behavior) {
                        case ce.FLIP:
                            r = [i, s];
                            break;
                    ...
                    return r.forEach(function (a, l) {
                        ...
                        var c, h = t.offsets.popper, u = t.offsets.reference, d = Math.floor,
                            f = "left" === i && d(h.right) > d(u.left) || "right" === i && d(h.left) < d(u.right) || "top" === i && d(h.bottom) > d(u.top) || "bottom" === i && d(h.top) < d(u.bottom),
                            p = d(h.left) < d(n.left), m = d(h.right) > d(n.right), g = d(h.top) < d(n.top),
                            v = d(h.bottom) > d(n.bottom),
                            y = "left" === i && p || "right" === i && m || "top" === i && g || "bottom" === i && v,
                            b = -1 !== ["top", "bottom"].indexOf(i),
                            _ = !!e.flipVariations && (b && "start" === o && p || b && "end" === o && m || !b && "start" === o && g || !b && "end" === o && v);
                        (f || y || _) && (t.flipped = !0, (f || y) && (i = r[l + 1]), _ && (o = "end" === (c = o) ? "start" : "start" === c ? "end" : c), t.placement = i + (o ? "-" + o : ""), t.offsets.popper = Ht({}, t.offsets.popper, Gt(t.instance.popper, t.offsets.reference, t.placement)), t = Qt(t.instance.modifiers, t, "flip"))
                    }), t
                }, behavior: "flip", padding: 5, boundariesElement: "viewport"
            }, inner: {
                order: 700, enabled: !1, fn: function (t) {
                    var e = t.placement, n = e.split("-")[0], i = t.offsets, s = i.popper, o = i.reference,
                        r = -1 !== ["left", "right"].indexOf(n), a = -1 === ["top", "left"].indexOf(n);
                    return s[r ? "left" : "top"] = o[n] - (a ? s[r ? "width" : "height"] : 0), t.placement = zt(e), t.offsets.popper = $t(s), t
                }
            }, hide: {
                order: 800, enabled: !0, fn: function (t) {
                    if (!oe(t.instance.modifiers, "hide", "preventOverflow")) return t;
                    var e = t.offsets.reference, n = Kt(t.instance.modifiers, function (t) {
                ...
                order: 850, enabled: !0, fn: function (t, e) {
                    var n = e.x, i = e.y, s = t.offsets.popper, o = Kt(t.instance.modifiers, function (t) {
                        return "applyStyle" === t.name
                    }).gpuAcceleration;
                    void 0 !== o && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var r, a, l, c, h, u, d, f, p, m, g, v, y, b, _ = void 0 !== o ? o : e.gpuAcceleration,
                        w = Et(t.instance.popper), D = Rt(w), k = {position: s.position},
                        C = (r = t, a = window.devicePixelRatio < 2 || !se, l = r.offsets, c = l.popper, h = l.reference, u = Math.round, d = Math.floor, f = function (t) {
                            ...
                            bottom: b(c.bottom),
                            right: y(c.right)
                        }), x = "bottom" === n ? "top" : "bottom", T = "right" === i ? "left" : "right",
                        S = Xt("transform"), E = void 0, M = void 0;
                    if (M = "bottom" === x ? "HTML" === w.nodeName ? -w.clientHeight + C.bottom : -D.height + C.bottom : C.top, E = "right" === T ? "HTML" === w.nodeName ? -w.clientWidth + C.right : -D.width + C.right : C.left, _ && S) k[S] = "translate3d(" + E + "px, " + M + "px, 0)", k[x] = 0, k[T] = 0, k.willChange = "transform"; else {
                        var A = "bottom" === x ? -1 : 1, O = "right" === T ? -1 : 1;
                        k[x] = M * A, k[T] = E * O, k.willChange = x + ", " + T
                    }
                    var I = {"x-placement": t.placement};
                    return t.attributes = Ht({}, I, t.attributes), t.styles = Ht({}, k, t.styles), t.arrowStyles = Ht({}, t.offsets.arrow, t.arrowStyles), t
                }, gpuAcceleration: !0, x: "bottom", y: "right"
            }, applyStyle: {
                order: 900, enabled: !0, fn: function (t) {
                    var e, n;
                    return ie(t.instance.popper, t.styles), e = t.instance.popper, n = t.attributes, Object.keys(n).forEach(function (t) {
                        !1 !== n[t] ? e.setAttribute(t, n[t]) : e.removeAttribute(t)
                    }), t.arrowElement && Object.keys(t.arrowStyles).length && ie(t.arrowElement, t.arrowStyles), t
                    ...
                    return e.setAttribute("x-placement", r), ie(e, {position: n.positionFixed ? "fixed" : "absolute"}), n
        ...
        function t(e, n) {
            ...
            }, this.update = _t(this.update.bind(this)), this.options = Ht({}, t.Defaults, s), this.state = {
                isDestroyed: !1,
                isCreated: !1,
                scrollParents: []
            }, this.reference = e && e.jquery ? e[0] : e, this.popper = n && n.jquery ? n[0] : n, this.options.modifiers = {}, Object.keys(Ht({}, t.Defaults.modifiers, s.modifiers)).forEach(function (e) {
                i.options.modifiers[e] = Ht({}, t.Defaults.modifiers[e] || {}, s.modifiers ? s.modifiers[e] : {})
            }), this.modifiers = Object.keys(this.options.modifiers).map(function (t) {
                return Ht({name: t}, i.options.modifiers[t])
            }).sort(function (t, e) {
            ...
            key: "update", value: function () {
                return function () {
                    if (!this.state.isDestroyed) {
                        ...
                        t.offsets.reference = Vt(this.state, this.popper, this.reference, this.options.positionFixed), t.placement = qt(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), t.originalPlacement = t.placement, t.positionFixed = this.options.positionFixed, t.offsets.popper = Gt(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", t = Qt(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, this.options.onCreate(t))
                    }
                }.call(this)
            }
        }, {
    ...
    de.Utils = ("undefined" != typeof window ? window : global).PopperUtils, de.placements = re, de.Defaults = ue;
    var fe = "dropdown", pe = "bs.dropdown", me = "." + pe, ge = ".data-api", ve = e.fn[fe],
        ye = new RegExp("38|40|27"), be = {
            HIDE: "hide" + me,
            HIDDEN: "hidden" + me,
            SHOW: "show" + me,
            SHOWN: "shown" + me,
        ...
        }, _e = "disabled", we = "show", De = "dropup", ke = "dropright", Ce = "dropleft", xe = "dropdown-menu-right",
        Te = "position-static", Se = '[data-toggle="dropdown"]', Ee = ".dropdown form", Me = ".dropdown-menu",
        Ae = ".navbar-nav", Oe = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Ie = "top-start",
        Ne = "top-end", Pe = "bottom-start", Le = "bottom-end", je = "right-start", Ye = "left-start",
        He = {offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic"}, $e = {
            ...
            return n.toggle = function () {
                if (!this._element.disabled && !e(this._element).hasClass(_e)) {
                    var n = t._getParentFromElement(this._element), i = e(this._menu).hasClass(we);
                    if (t._clearMenus(), !i) {
                        var s = {relatedTarget: this._element}, o = e.Event(be.SHOW, s);
                        if (e(n).trigger(o), !o.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var r = this._element;
                                "parent" === this._config.reference ? r = n : a.isElement(this._config.reference) && (r = this._config.reference, void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && e(n).addClass(Te), this._popper = new de(r, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === e(n).closest(Ae).length && e(document.body).children().on("mouseover", null, e.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), e(this._menu).toggleClass(we), e(n).toggleClass(we).trigger(e.Event(be.SHOWN, s))
                        }
                    }
                }
            }, n.show = function () {
                if (!(this._element.disabled || e(this._element).hasClass(_e) || e(this._menu).hasClass(we))) {
                    var n = {relatedTarget: this._element}, i = e.Event(be.SHOW, n),
                        s = t._getParentFromElement(this._element);
                    e(s).trigger(i), i.isDefaultPrevented() || (e(this._menu).toggleClass(we), e(s).toggleClass(we).trigger(e.Event(be.SHOWN, n)))
                }
            }, n.hide = function () {
                if (!this._element.disabled && !e(this._element).hasClass(_e) && e(this._menu).hasClass(we)) {
                    var n = {relatedTarget: this._element}, i = e.Event(be.HIDE, n),
                        s = t._getParentFromElement(this._element);
                    e(s).trigger(i), i.isDefaultPrevented() || (e(this._menu).toggleClass(we), e(s).toggleClass(we).trigger(e.Event(be.HIDDEN, n)))
                }
            }, n.dispose = function () {
                e.removeData(this._element, pe), e(this._element).off(me), this._element = null, this._menu = null, null !== this._popper && (this._popper.destroy(), this._popper = null)
            }, n.update = function () {
                this._inNavbar = this._detectNavbar(), null !== this._popper && this._popper.scheduleUpdate()
            }, n._addEventListeners = function () {
                var t = this;
                e(this._element).on(be.CLICK, function (e) {
                    e.preventDefault(), e.stopPropagation(), t.toggle()
                })
            }, n._getConfig = function (t) {
                return t = s({}, this.constructor.Default, e(this._element).data(), t), a.typeCheckConfig(fe, t, this.constructor.DefaultType), t
                ...
                var t = e(this._element.parentNode), n = Pe;
                return t.hasClass(De) ? (n = Ie, e(this._menu).hasClass(xe) && (n = Ne)) : t.hasClass(ke) ? n = je : t.hasClass(Ce) ? n = Ye : e(this._menu).hasClass(xe) && (n = Le), n
                ...
                if (!n || 3 !== n.which && ("keyup" !== n.type || 9 === n.which)) for (var i = [].slice.call(document.querySelectorAll(Se)), s = 0, o = i.length; s < o; s++) {
                    var r = t._getParentFromElement(i[s]), a = e(i[s]).data(pe), l = {relatedTarget: i[s]};
                    if (n && "click" === n.type && (l.clickEvent = n), a) {
                        ...
                        if (e(r).hasClass(we) && !(n && ("click" === n.type && /input|textarea/i.test(n.target.tagName) || "keyup" === n.type && 9 === n.which) && e.contains(r, n.target))) {
                            ...
                            e(r).trigger(h), h.isDefaultPrevented() || ("ontouchstart" in document.documentElement && e(document.body).children().off("mouseover", null, e.noop), i[s].setAttribute("aria-expanded", "false"), e(c).removeClass(we), e(r).removeClass(we).trigger(e.Event(be.HIDDEN, l)))
                        }
                    }
                }
                ...
                if ((/input|textarea/i.test(n.target.tagName) ? !(32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || e(n.target).closest(Me).length)) : ye.test(n.which)) && (n.preventDefault(), n.stopPropagation(), !this.disabled && !e(this).hasClass(_e))) {
                    var i = t._getParentFromElement(this), s = e(i).hasClass(we);
    ...
    e(document).on(be.KEYDOWN_DATA_API, Se, Re._dataApiKeydownHandler).on(be.KEYDOWN_DATA_API, Me, Re._dataApiKeydownHandler).on(be.CLICK_DATA_API + " " + be.KEYUP_DATA_API, Re._clearMenus).on(be.CLICK_DATA_API, Se, function (t) {
        t.preventDefault(), t.stopPropagation(), Re._jQueryInterface.call(e(this), "toggle")
    }).on(be.CLICK_DATA_API, Ee, function (t) {
        t.stopPropagation()
    }), e.fn[fe] = Re._jQueryInterface, e.fn[fe].Constructor = Re, e.fn[fe].noConflict = function () {
        return e.fn[fe] = ve, Re._jQueryInterface
    };
    var We = "modal", Ue = "bs.modal", Fe = "." + Ue, qe = e.fn[We],
        Ve = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        Be = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, ze = {
            HIDE: "hide" + Fe,
            HIDDEN: "hidden" + Fe,
            SHOW: "show" + Fe,
            SHOWN: "shown" + Fe,
        ...
        }, Ge = "modal-dialog-scrollable", Ke = "modal-scrollbar-measure", Qe = "modal-backdrop", Ze = "modal-open",
        Xe = "fade", Je = "show", tn = {
            DIALOG: ".modal-dialog",
            ...
            function t(t, e) {
                this._config = this._getConfig(e), this._element = t, this._dialog = t.querySelector(tn.DIALOG), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollbarWidth = 0
            }
            ...
            return n.toggle = function (t) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    e(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), e(this._element).on(ze.CLICK_DISMISS, tn.DATA_DISMISS, function (t) {
                        return n.hide(t)
                ...
                [window, this._element, this._dialog].forEach(function (t) {
                    return e(t).off(Fe)
                }), e(document).off(ze.FOCUSIN), e.removeData(this._element, Ue), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
            }, n.handleUpdate = function () {
                this._adjustDialog()
            }, n._getConfig = function (t) {
                return t = s({}, Ve, t), a.typeCheckConfig(We, t, Be), t
            }, n._showElement = function (t) {
                var n = this, i = e(this._element).hasClass(Xe);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), e(this._dialog).hasClass(Ge) ? this._dialog.querySelector(tn.MODAL_BODY).scrollTop = 0 : this._element.scrollTop = 0, i && a.reflow(this._element), e(this._element).addClass(Je), this._config.focus && this._enforceFocus();
                var s = e.Event(ze.SHOWN, {relatedTarget: t}), o = function () {
                ...
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function () {
                    e(document.body).removeClass(Ze), t._resetAdjustments(), t._resetScrollbar(), e(t._element).trigger(ze.HIDDEN)
                })
            }, n._removeBackdrop = function () {
                this._backdrop && (e(this._backdrop).remove(), this._backdrop = null)
            }, n._showBackdrop = function (t) {
                var n = this, i = e(this._element).hasClass(Xe) ? Xe : "";
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = Qe, i && this._backdrop.classList.add(i), e(this._backdrop).appendTo(document.body), e(this._element).on(ze.CLICK_DISMISS, function (t) {
                ...
                if (this._isBodyOverflowing) {
                    ...
                    e(n).each(function (n, i) {
                        ...
                        var s = i.style.marginRight, o = e(i).css("margin-right");
                ...
                t.className = Ke, document.body.appendChild(t);
                var e = t.getBoundingClientRect().width - t.clientWidth;
                return document.body.removeChild(t), e
            }, t._jQueryInterface = function (n, i) {
                return this.each(function () {
                    var o = e(this).data(Ue), r = s({}, Ve, e(this).data(), "object" == typeof n && n ? n : {});
    ...
    e(document).on(ze.CLICK_DATA_API, tn.DATA_TOGGLE, function (t) {
        var n, i = this, o = a.getSelectorFromElement(this);
        o && (n = document.querySelector(o));
        var r = e(n).data(Ue) ? "toggle" : s({}, e(n).data(), e(this).data());
    ...
    }), e.fn[We] = en._jQueryInterface, e.fn[We].Constructor = en, e.fn[We].noConflict = function () {
        return e.fn[We] = qe, en._jQueryInterface
    };
    var nn = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"], sn = {
    ...
    function an(t, e, n) {
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), s = Object.keys(e), o = [].slice.call(i.body.querySelectorAll("*")), r = function (t, n) {
            var i = o[t], r = i.nodeName.toLowerCase();
    ...
    var ln = "tooltip", cn = "bs.tooltip", hn = "." + cn, un = e.fn[ln], dn = "bs-tooltip",
        fn = new RegExp("(^|\\s)" + dn + "\\S+", "g"), pn = ["sanitize", "whiteList", "sanitizeFn"], mn = {
            animation: "boolean",
            template: "string",
            ...
            whiteList: "object"
        }, gn = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, vn = {
            animation: !0,
        ...
        }, wn = "fade", Dn = "show", kn = ".tooltip-inner", Cn = ".arrow", xn = "hover", Tn = "focus", Sn = "click",
        En = "manual", Mn = function () {
            function t(t, e) {
            ...
            return n.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var o = this.getTipElement(), r = a.getUID(this.constructor.NAME);
                    o.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && e(o).addClass(wn);
                    var l = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
                        c = this._getAttachment(l);
                    this.addAttachmentClass(c);
                    var h = this._getContainer();
                    e(o).data(this.constructor.DATA_KEY, this), e.contains(this.element.ownerDocument.documentElement, this.tip) || e(o).appendTo(h), e(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new de(this.element, o, {
                        placement: c,
                        modifiers: {
                            offset: this._getOffset(),
                    ...
                    }), e(o).addClass(Dn), "ontouchstart" in document.documentElement && e(document.body).children().on("mouseover", null, e.noop);
                    var u = function () {
                        t.config.animation && t._fixTransition();
                        var n = t._hoverState;
                        t._hoverState = null, e(t.element).trigger(t.constructor.Event.SHOWN), n === bn && t._leave(null, t)
                    };
                ...
                var n = this, i = this.getTipElement(), s = e.Event(this.constructor.Event.HIDE), o = function () {
                    n._hoverState !== yn && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), e(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), t && t()
                };
                ...
                this.setElementContent(e(t.querySelectorAll(kn)), this.getTitle()), e(t).removeClass(wn + " " + Dn)
                ...
                var i = this.constructor.DATA_KEY;
                (n = n || e(t.currentTarget).data(i)) || (n = new this.constructor(t.currentTarget, this._getDelegateConfig()), e(t.currentTarget).data(i, n)), t && (n._activeTrigger["focusout" === t.type ? Tn : xn] = !1), n._isWithActiveTrigger() || (clearTimeout(n._timeout), n._hoverState = bn, n.config.delay && n.config.delay.hide ? n._timeout = setTimeout(function () {
                ...
                return Object.keys(n).forEach(function (t) {
                    -1 !== pn.indexOf(t) && delete n[t]
                }), "number" == typeof (t = s({}, this.constructor.Default, n, "object" == typeof t && t ? t : {})).delay && (t.delay = {
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), a.typeCheckConfig(ln, t, this.constructor.DefaultType), t.sanitize && (t.template = an(t.template, t.whiteList, t.sanitizeFn)), t
            }, n._getDelegateConfig = function () {
                var t = {};
                if (this.config) for (var e in this.config) this.constructor.Default[e] !== this.config[e] && (t[e] = this.config[e]);
                return t
            }, n._cleanTipClass = function () {
                var t = e(this.getTipElement()), n = t.attr("class").match(fn);
                ...
                return this.each(function () {
                    var i = e(this).data(cn), s = "object" == typeof n && n;
    ...
    e.fn[ln] = Mn._jQueryInterface, e.fn[ln].Constructor = Mn, e.fn[ln].noConflict = function () {
        return e.fn[ln] = un, Mn._jQueryInterface
    };
    var An = "popover", On = "bs.popover", In = "." + On, Nn = e.fn[An], Pn = "bs-popover",
        Ln = new RegExp("(^|\\s)" + Pn + "\\S+", "g"), jn = s({}, Mn.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), Yn = s({}, Mn.DefaultType, {content: "(string|element|function)"}), Hn = "fade", $n = "show",
        Rn = ".popover-header", Wn = ".popover-body", Un = {
            HIDE: "hide" + In,
            HIDDEN: "hidden" + In,
            SHOW: "show" + In,
            SHOWN: "shown" + In,
            ...
            s = t, (n = o).prototype = Object.create(s.prototype), n.prototype.constructor = n, n.__proto__ = s;
            var r = o.prototype;
            return r.isWithContent = function () {
                ...
                "function" == typeof n && (n = n.call(this.element)), this.setElementContent(t.find(Wn), n), t.removeClass(Hn + " " + $n)
            }, r._getContent = function () {
                return this.element.getAttribute("data-content") || this.config.content
            }, r._cleanTipClass = function () {
                var t = e(this.getTipElement()), n = t.attr("class").match(Ln);
                null !== n && n.length > 0 && t.removeClass(n.join(""))
            }, o._jQueryInterface = function (t) {
                return this.each(function () {
                    var n = e(this).data(On), i = "object" == typeof t ? t : null;
    ...
    e.fn[An] = Fn._jQueryInterface, e.fn[An].Constructor = Fn, e.fn[An].noConflict = function () {
        return e.fn[An] = Nn, Fn._jQueryInterface
    };
    var qn = "scrollspy", Vn = "bs.scrollspy", Bn = "." + Vn, zn = e.fn[qn],
        Gn = {offset: 10, method: "auto", target: ""},
        Kn = {offset: "number", method: "string", target: "(string|element)"},
        Qn = {ACTIVATE: "activate" + Bn, SCROLL: "scroll" + Bn, LOAD_DATA_API: "load" + Bn + ".data-api"},
        Zn = "dropdown-item", Xn = "active", Jn = {
            ...
            function t(t, n) {
                var i = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(n), this._selector = this._config.target + " " + Jn.NAV_LINKS + "," + this._config.target + " " + Jn.LIST_ITEMS + "," + this._config.target + " " + Jn.DROPDOWN_ITEMS, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, e(this._scrollElement).on(Qn.SCROLL, function (t) {
                    return i._process(t)
            ...
            return n.refresh = function () {
                var t = this, n = this._scrollElement === this._scrollElement.window ? ti : ei,
                    i = "auto" === this._config.method ? n : this._config.method, s = i === ei ? this._getScrollTop() : 0;
                ...
                e.removeData(this._element, Vn), e(this._scrollElement).off(Bn), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, n._getConfig = function (t) {
                if ("string" != typeof (t = s({}, Gn, "object" == typeof t && t ? t : {})).target) {
                    var n = e(t.target).attr("id");
                    n || (n = a.getUID(qn), e(t.target).attr("id", n)), t.target = "#" + n
                }
                return a.typeCheckConfig(qn, t, Kn), t
                ...
                i.hasClass(Zn) ? (i.closest(Jn.DROPDOWN).find(Jn.DROPDOWN_TOGGLE).addClass(Xn), i.addClass(Xn)) : (i.addClass(Xn), i.parents(Jn.NAV_LIST_GROUP).prev(Jn.NAV_LINKS + ", " + Jn.LIST_ITEMS).addClass(Xn), i.parents(Jn.NAV_LIST_GROUP).prev(Jn.NAV_ITEMS).children(Jn.NAV_LINKS).addClass(Xn)), e(this._scrollElement).trigger(Qn.ACTIVATE, {relatedTarget: t})
            }, n._clear = function () {
    ...
    e(window).on(Qn.LOAD_DATA_API, function () {
        ...
        return e.fn[qn] = zn, ni._jQueryInterface
    };
    var ii = "bs.tab", si = "." + ii, oi = e.fn.tab, ri = {
            HIDE: "hide" + si,
            HIDDEN: "hidden" + si,
            SHOW: "show" + si,
            SHOWN: "shown" + si,
            CLICK_DATA_API: "click" + si + ".data-api"
        }, ai = "dropdown-menu", li = "active", ci = "disabled", hi = "fade", ui = "show", di = ".dropdown",
        fi = ".nav, .list-group", pi = ".active", mi = "> li > .active",
        gi = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', vi = ".dropdown-toggle",
        yi = "> .dropdown-menu .active", bi = function () {
            ...
            return n.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(li) || e(this._element).hasClass(ci))) {
                    var n, i, s = e(this._element).closest(fi)[0], o = a.getSelectorFromElement(this._element);
                    if (s) {
                        var r = "UL" === s.nodeName || "OL" === s.nodeName ? mi : pi;
                        i = (i = e.makeArray(e(s).find(r)))[i.length - 1]
                    }
                    var l = e.Event(ri.HIDE, {relatedTarget: this._element}), c = e.Event(ri.SHOW, {relatedTarget: i});
                    if (i && e(i).trigger(l), e(this._element).trigger(c), !c.isDefaultPrevented() && !l.isDefaultPrevented()) {
                        o && (n = document.querySelector(o)), this._activate(this._element, s);
                        var h = function () {
                            var n = e.Event(ri.HIDDEN, {relatedTarget: t._element}),
                                s = e.Event(ri.SHOWN, {relatedTarget: i});
                ...
                e.removeData(this._element, ii), this._element = null
            }, n._activate = function (t, n, i) {
                var s = this, o = (!n || "UL" !== n.nodeName && "OL" !== n.nodeName ? e(n).children(pi) : e(n).find(mi))[0],
                    r = i && o && e(o).hasClass(hi), l = function () {
                ...
                if (n) {
                    ...
                    s && e(s).removeClass(li), "tab" === n.getAttribute("role") && n.setAttribute("aria-selected", !1)
                }
    ...
    e(document).on(ri.CLICK_DATA_API, gi, function (t) {
        t.preventDefault(), bi._jQueryInterface.call(e(this), "show")
    }), e.fn.tab = bi._jQueryInterface, e.fn.tab.Constructor = bi, e.fn.tab.noConflict = function () {
        return e.fn.tab = oi, bi._jQueryInterface
    };
    var _i = "toast", wi = "bs.toast", Di = "." + wi, ki = e.fn[_i], Ci = {
            CLICK_DISMISS: "click.dismiss" + Di,
            HIDE: "hide" + Di,
            HIDDEN: "hidden" + Di,
            SHOW: "show" + Di,
            SHOWN: "shown" + Di
        }, xi = "fade", Ti = "hide", Si = "show", Ei = "showing",
        Mi = {animation: "boolean", autohide: "boolean", delay: "number"},
        Ai = {animation: !0, autohide: !0, delay: 500}, Oi = '[data-dismiss="toast"]', Ii = function () {
            function t(t, e) {
            ...
            return n.show = function () {
                var t = this;
                e(this._element).trigger(Ci.SHOW), this._config.animation && this._element.classList.add(xi);
                var n = function () {
                    t._element.classList.remove(Ei), t._element.classList.add(Si), e(t._element).trigger(Ci.SHOWN), t._config.autohide && t.hide()
                };
                ...
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Si) && this._element.classList.remove(Si), e(this._element).off(Ci.CLICK_DISMISS), e.removeData(this._element, wi), this._element = null, this._config = null
            }, n._getConfig = function (t) {
                return t = s({}, Ai, e(this._element).data(), "object" == typeof t && t ? t : {}), a.typeCheckConfig(_i, t, this.constructor.DefaultType), t
            }, n._setListeners = function () {
                var t = this;
                e(this._element).on(Ci.CLICK_DISMISS, Oi, function () {
                    return t.hide(!0)
                })
            }, n._close = function () {
                var t = this, n = function () {
                    t._element.classList.add(Ti), e(t._element).trigger(Ci.HIDDEN)
                };
    ...
    e.fn[_i] = Ii._jQueryInterface, e.fn[_i].Constructor = Ii, e.fn[_i].noConflict = function () {
        return e.fn[_i] = ki, Ii._jQueryInterface
    }, function () {
        if (void 0 === e) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
        var t = e.fn.jquery.split(" ")[0].split(".");
        if (t[0] < 2 && t[1] < 9 || 1 === t[0] && 9 === t[1] && t[2] < 1 || t[0] >= 4) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
    }(), t.Util = a, t.Alert = g, t.Button = O, t.Carousel = tt, t.Collapse = mt, t.Dropdown = Re, t.Modal = en, t.Popover = Fn, t.Scrollspy = ni, t.Tab = bi, t.Toast = Ii, t.Tooltip = Mn, Object.defineProperty(t, "__esModule", {value: !0})
}), function (t, e) {
    ...
    function f(t) {
        if (null == t._isValid) {
            var n = d(t), i = e.call(n.parsedDateParts, function (t) {
                    return null != t
                }),
    ...
    function M(t, e) {
        var n, i = h({}, t);
        for (n in e) c(e, n) && (s(t[n]) && s(e[n]) ? (i[n] = {}, h(i[n], t[n]), h(i[n], e[n])) : null != e[n] ? i[n] = e[n] : delete i[n]);
        for (n in t) c(t, n) && !c(e, n) && s(t[n]) && (i[n] = h({}, i[n]));
        return i
    }
    ...
    n.suppressDeprecationWarnings = !1, n.deprecationHandler = null, x = Object.keys ? Object.keys : function (t) {
        var e, n = [];
    ...
    function F(t, e) {
        return t.isValid() ? (e = q(e, t.localeData()), R[e] = R[e] || function (t) {
    ...
    function q(t, e) {
        ...
        for ($.lastIndex = 0; n >= 0 && $.test(t);) t = t.replace($, i), $.lastIndex = 0, n -= 1;
        return t
    }

    var V = /\d/, B = /\d\d/, z = /\d{3}/, G = /\d{4}/, K = /[+-]?\d{6}/, Q = /\d\d?/, Z = /\d\d\d\d?/,
        X = /\d\d\d\d\d\d?/, J = /\d{1,3}/, tt = /\d{1,4}/, et = /[+-]?\d{1,6}/, nt = /\d+/, it = /[+-]?\d+/,
        st = /Z|[+-]\d\d:?\d\d/gi, ot = /Z|[+-]\d\d(?::?\d\d)?/gi,
    ...
    function ct(t, e) {
        return c(at, t) ? at[t](e._strict, e._locale) : new RegExp(ht(t.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function (t, e, n, i, s) {
            return e || n || i || s
        })))
    }
    ...
    var pt = 0, mt = 1, gt = 2, vt = 3, yt = 4, bt = 5, _t = 6, wt = 7, Dt = 8;
    ...
    }), U(0, ["YYYY", 4], 0, "year"), U(0, ["YYYYY", 5], 0, "year"), U(0, ["YYYYYY", 6, !0], 0, "year"), I("year", "y"), j("year", 1), lt("Y", it), lt("YY", Q, B), lt("YYYY", tt, G), lt("YYYYY", et, K), lt("YYYYYY", et, K), dt(["YYYYY", "YYYYYY"], pt), dt("YYYY", function (t, e) {
    ...
    }), I("month", "M"), j("month", 8), lt("M", Q), lt("MM", Q, B), lt("MMM", function (t, e) {
    ...
    function Pt(t, e) {
        ...
        if ("string" == typeof e) if (/^\d+$/.test(e)) e = w(e); else if (!r(e = t.localeData().monthsParse(e))) return t;
    ...
    function Ht() {
        ...
        var e, n, i = [], s = [], o = [];
        for (e = 0; e < 12; e++) n = u([2e3, e]), i.push(this.monthsShort(n, "")), s.push(this.months(n, "")), o.push(this.months(n, "")), o.push(this.monthsShort(n, ""));
    ...
    function Ut(t, e, n) {
        var i, s, o = Rt(t.year(), e, n), r = Math.floor((t.dayOfYear() - o - 1) / 7) + 1;
    ...
    function Ft(t, e, n) {
        var i = Rt(t, e, n), s = Rt(t + 1, e, n);
        return (kt(t) - i + s) / 7
    }

    U("w", ["ww", 2], "wo", "week"), U("W", ["WW", 2], "Wo", "isoWeek"), I("week", "w"), I("isoWeek", "W"), j("week", 5), j("isoWeek", 5), lt("w", Q), lt("ww", Q, B), lt("W", Q), lt("WW", Q, B), ft(["w", "ww", "W", "WW"], function (t, e, n, i) {
        e[i.substr(0, 1)] = w(t)
    });
    ...
    function Zt() {
        ...
        for (e = 0; e < 7; e++) n = u([2e3, 1]).day(e), i = this.weekdaysMin(n, ""), s = this.weekdaysShort(n, ""), o = this.weekdays(n, ""), r.push(i), a.push(s), l.push(o), c.push(i), c.push(s), c.push(o);
    ...
    }), Jt("a", !0), Jt("A", !1), I("hour", "h"), j("hour", 13), lt("a", te), lt("A", te), lt("H", Q), lt("h", Q), lt("k", Q), lt("HH", Q, B), lt("hh", Q, B), lt("kk", Q, B), lt("hmm", Z), lt("hmmss", X), lt("Hmm", Z), lt("Hmmss", X), dt(["H", "HH"], vt), dt(["k", "kk"], function (t, e, n) {
        var i = w(t);
        e[vt] = 24 === i ? 0 : i
    ...
    function le(t, e) {
        var n;
        return t && ((n = o(e) ? he(t) : ce(t, e)) ? ee = n : "undefined" != typeof console && console.warn && console.warn("Locale " + t + " not found. Did you forget to load it?")), ee._abbr
    }

    function ce(t, e) {
        if (null !== e) {
            var n, i = ie;
            if (e.abbr = t, null != se[t]) S("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), i = se[t]._config; else if (null != e.parentLocale) if (null != se[e.parentLocale]) i = se[e.parentLocale]._config; else {
    ...
    function ue(t) {
        var e, n = t._a;
        return n && -2 === d(t).overflow && (e = n[mt] < 0 || n[mt] > 11 ? mt : n[gt] < 1 || n[gt] > At(n[pt], n[mt]) ? gt : n[vt] < 0 || n[vt] > 24 || 24 === n[vt] && (0 !== n[yt] || 0 !== n[bt] || 0 !== n[_t]) ? vt : n[yt] < 0 || n[yt] > 59 ? yt : n[bt] < 0 || n[bt] > 59 ? bt : n[_t] < 0 || n[_t] > 999 ? _t : -1, d(t)._overflowDayOfYear && (e < pt || e > gt) && (e = gt), d(t)._overflowWeeks && -1 === e && (e = wt), d(t)._overflowWeekday && -1 === e && (e = Dt), d(t).overflow = e), t
    }
    ...
    function fe(t) {
        ...
        if (!t._d) {
            ...
            for (l = t, c = new Date(n.now()), s = l._useUTC ? [c.getUTCFullYear(), c.getUTCMonth(), c.getUTCDate()] : [c.getFullYear(), c.getMonth(), c.getDate()], t._w && null == t._a[gt] && null == t._a[mt] && function (t) {
                var e, n, i, s, o, r, a, l;
                if (null != (e = t._w).GG || null != e.W || null != e.E) o = 1, r = 4, n = de(e.GG, t._a[pt], Ut(Ee(), 1, 4).year), i = de(e.W, 1), ((s = de(e.E, 1)) < 1 || s > 7) && (l = !0); else {
                    o = t._locale._week.dow, r = t._locale._week.doy;
                    var c = Ut(Ee(), o, r);
                    n = de(e.gg, t._a[pt], c.year), i = de(e.w, c.week), null != e.d ? ((s = e.d) < 0 || s > 6) && (l = !0) : null != e.e ? (s = e.e + o, (e.e < 0 || e.e > 6) && (l = !0)) : s = o
                }
            ...
            24 === t._a[vt] && 0 === t._a[yt] && 0 === t._a[bt] && 0 === t._a[_t] && (t._nextDay = !0, t._a[vt] = 0), t._d = (t._useUTC ? $t : function (t, e, n, i, s, o, r) {
                var a;
                return t < 100 && t >= 0 ? (a = new Date(t + 400, e, n, i, s, o, r), isFinite(a.getFullYear()) && a.setFullYear(t)) : a = new Date(t, e, n, i, s, o, r), a
            }).apply(null, a), o = t._useUTC ? t._d.getUTCDay() : t._d.getDay(), null != t._tzm && t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), t._nextDay && (t._a[vt] = 24), t._w && void 0 !== t._w.d && t._w.d !== o && (d(t).weekdayMismatch = !0)
        }
    }
    ...
    function _e(t) {
        var e, n, i, s, o, r, a = t._i, l = pe.exec(a) || me.exec(a);
        if (l) {
    ...
    var ke = {UT: 0, GMT: 0, EDT: -240, EST: -300, CDT: -300, CST: -360, MDT: -360, MST: -420, PDT: -420, PST: -480};
    ...
    function Ce(t) {
        ...
        if (s) {
            ...
            t._a = o, t._tzm = function (t, e, n) {
                ...
                return (i - s) / 100 * 60 + s
            }(s[8], s[9], s[10]), t._d = $t.apply(null, t._a), t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), d(t).rfc2822 = !0
        } else t._isValid = !1
    }
    ...
    function xe(t) {
        if (t._f !== n.ISO_8601) if (t._f !== n.RFC_2822) {
            t._a = [], d(t).empty = !0;
            var e, i, s, o, r, a, l, h, u = "" + t._i, f = u.length, p = 0;
            for (s = q(t._f, t._locale).match(H) || [], e = 0; e < s.length; e++) o = s[e], (i = (u.match(ct(o, t)) || [])[0]) && ((r = u.substr(0, u.indexOf(i))).length > 0 && d(t).unusedInput.push(r), u = u.slice(u.indexOf(i) + i.length), p += i.length), W[o] ? (i ? d(t).empty = !1 : d(t).unusedTokens.push(o), a = o, h = t, null != (l = i) && c(ut, a) && ut[a](l, h._a, h, a)) : t._strict && !i && d(t).unusedTokens.push(o);
            d(t).charsLeftOver = f - p, u.length > 0 && d(t).unusedInput.push(u), t._a[vt] <= 12 && !0 === d(t).bigHour && t._a[vt] > 0 && (d(t).bigHour = void 0), d(t).parsedDateParts = t._a.slice(0), d(t).meridiem = t._meridiem, t._a[vt] = function (t, e, n) {
                var i;
                if (null == n) return e;
    ...
    function Te(t) {
        var e, c, u, m, v = t._i, _ = t._f;
        return t._locale = t._locale || he(t._l), null === v || void 0 === _ && "" === v ? p({nullInput: !0}) : ("string" == typeof v && (t._i = v = t._locale.preparse(v)), b(v) ? new y(ue(v)) : (a(v) ? t._d = v : i(_) ? function (t) {
            var e, n, i, s, o;
            if (0 === t._f.length) return d(t).invalidFormat = !0, void (t._d = new Date(NaN));
            for (s = 0; s < t._f.length; s++) o = 0, e = g({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[s], xe(e), f(e) && (o += d(e).charsLeftOver, o += 10 * d(e).unusedTokens.length, d(e).score = o, (null == i || o < i) && (i = o, n = e));
            h(t, n || e)
        }(t) : _ ? xe(t) : o(c = (e = t)._i) ? e._d = new Date(n.now()) : a(c) ? e._d = new Date(c.valueOf()) : "string" == typeof c ? (u = e, null === (m = be.exec(u._i)) ? (_e(u), !1 === u._isValid && (delete u._isValid, Ce(u), !1 === u._isValid && (delete u._isValid, n.createFromInputFallback(u)))) : u._d = new Date(+m[1])) : i(c) ? (e._a = l(c.slice(0), function (t) {
    ...
    function Se(t, e, n, o, r) {
        var a, l = {};
        return !0 !== n && !1 !== n || (o = n, n = void 0), (s(t) && function (t) {
            if (Object.getOwnPropertyNames) return 0 === Object.getOwnPropertyNames(t).length;
            var e;
            for (e in t) if (t.hasOwnProperty(e)) return !1;
            return !0
        }(t) || i(t) && 0 === t.length) && (t = void 0), l._isAMomentObject = !0, l._useUTC = l._isUTC = r, l._l = n, l._i = t, l._f = e, l._strict = o, (a = new y(ue(Te(l))))._nextDay && (a.add(1, "d"), a._nextDay = void 0), a
    }
    ...
    var Me = C("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", function () {
        ...
        Ae = C("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/", function () {
            var t = Ee.apply(null, arguments);
            return this.isValid() && t.isValid() ? t > this ? this : t : p()
        });
    ...
    function Ne(t) {
        var e = P(t), n = e.year || 0, i = e.quarter || 0, s = e.month || 0, o = e.week || e.isoWeek || 0,
            r = e.day || 0, a = e.hour || 0, l = e.minute || 0, c = e.second || 0, h = e.millisecond || 0;
        this._isValid = function (t) {
            for (var e in t) if (-1 === xt.call(Ie, e) || null != t[e] && isNaN(t[e])) return !1;
            for (var n = !1, i = 0; i < Ie.length; ++i) if (t[Ie[i]]) {
                if (n) return !1;
    ...
    function He(t, e) {
        ...
        var i = ((n[n.length - 1] || []) + "").match(Ye) || ["-", 0, 0], s = 60 * i[1] + w(i[2]);
    ...
    function qe(t, e) {
        var n, i, s, o = t, a = null;
        return Pe(t) ? o = {
            ms: t._milliseconds,
            d: t._days,
            M: t._months
        } : r(t) ? (o = {}, e ? o[e] = t : o.milliseconds = t) : (a = Ue.exec(t)) ? (n = "-" === a[1] ? -1 : 1, o = {
            y: 0,
            d: w(a[gt]) * n,
            h: w(a[vt]) * n,
            m: w(a[yt]) * n,
            ...
            return n
        }(Ee(o.from), Ee(o.to)), (o = {}).ms = s.milliseconds, o.M = s.months), i = new Ne(o), Pe(t) && c(t, "_locale") && (i._locale = t._locale), i
    }
    ...
    function ze(t, e) {
        return function (n, i) {
            var s;
            return null === i || isNaN(+i) || (S(e, "moment()." + e + "(period, number) is deprecated. Please use moment()." + e + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), s = n, n = i, i = s), Ge(this, qe(n = "string" == typeof n ? +n : n, i), t), this
        }
    }

    function Ge(t, e, i, s) {
        var o = e._milliseconds, r = Le(e._days), a = Le(e._months);
    ...
    var Ke = ze(1, "add"), Qe = ze(-1, "subtract");
    ...
    var en = 1e3, nn = 60 * en, sn = 60 * nn, on = 3506328 * sn;
    ...
    function hn(t, e, n, i, s) {
        var o;
        return null == t ? Ut(this, i, s).year : (e > (o = Ft(t, i, s)) && (e = o), function (t, e, n, i, s) {
            var o = Wt(t, e, n, i, s), r = $t(o.year, 0, o.dayOfYear);
    ...
    }), cn("gggg", "weekYear"), cn("ggggg", "weekYear"), cn("GGGG", "isoWeekYear"), cn("GGGGG", "isoWeekYear"), I("weekYear", "gg"), I("isoWeekYear", "GG"), j("weekYear", 1), j("isoWeekYear", 1), lt("G", it), lt("g", it), lt("GG", Q, B), lt("gg", Q, B), lt("GGGG", tt, G), lt("gggg", tt, G), lt("GGGGG", et, K), lt("ggggg", et, K), ft(["gggg", "ggggg", "GGGG", "GGGGG"], function (t, e, n, i) {
        e[i.substr(0, 2)] = w(t)
    }), ft(["gg", "GG"], function (t, e, i, s) {
        e[s] = n.parseTwoDigitYear(t)
    }), U("Q", 0, "Qo", "quarter"), I("quarter", "Q"), j("quarter", 7), lt("Q", V), dt("Q", function (t, e) {
        e[mt] = 3 * (w(t) - 1)
    }), U("D", ["DD", 2], "Do", "date"), I("date", "D"), j("date", 9), lt("D", Q), lt("DD", Q, B), lt("Do", function (t, e) {
    ...
    U("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), I("dayOfYear", "DDD"), j("dayOfYear", 4), lt("DDD", J), lt("DDDD", z), dt(["DDD", "DDDD"], function (t, e, n) {
        n._dayOfYear = w(t)
    }), U("m", ["mm", 2], 0, "minute"), I("minute", "m"), j("minute", 14), lt("m", Q), lt("mm", Q, B), dt(["m", "mm"], yt);
    var dn = St("Minutes", !1);
    U("s", ["ss", 2], 0, "second"), I("second", "s"), j("second", 15), lt("s", Q), lt("ss", Q, B), dt(["s", "ss"], bt);
    ...
    vn.add = Ke, vn.calendar = function (t, e) {
        var i = t || Ee(), s = $e(i, this).startOf("day"), o = n.calendarFormat(this, s) || "sameElse",
        ...
        switch (t) {
            ...
            case"date":
                ...
                break;
            case"hour":
                e = this._d.valueOf(), e += sn - rn(e + (this._isUTC ? 0 : this.utcOffset() * nn), sn) - 1;
                break;
            case"minute":
                e = this._d.valueOf(), e += nn - rn(e, nn) - 1;
                break;
            case"second":
                e = this._d.valueOf(), e += en - rn(e, en) - 1
        }
        ...
        return f(this)
    }, vn.lang = Je, vn.locale = Xe, vn.localeData = tn, vn.max = Ae, vn.min = Me, vn.parsingFlags = function () {
        return h({}, d(this))
    }, vn.set = function (t, e) {
        ...
        }(t = P(t)), i = 0; i < n.length; i++) this[n[i].unit](t[n[i].unit]); else if (E(this[t = N(t)])) return this[t](e);
        return this
        ...
        switch (t) {
            ...
            case"date":
                ...
                break;
            case"hour":
                e = this._d.valueOf(), e -= rn(e + (this._isUTC ? 0 : this.utcOffset() * nn), sn);
                break;
            case"minute":
                e = this._d.valueOf(), e -= rn(e, nn);
                break;
            case"second":
                e = this._d.valueOf(), e -= rn(e, en)
        }
        return this._d.setTime(e), n.updateOffset(this, !0), this
        ...
        var n = "[" + t + '("]', i = 0 <= this.year() && this.year() <= 9999 ? "YYYY" : "YYYYYY", s = e + '[")]';
    ...
    }, vn.year = Tt, vn.isLeapYear = function () {
        return Ct(this.year())
    ...
    }, vn.month = Lt, vn.daysInMonth = function () {
    ...
    }, vn.date = un, vn.day = vn.days = function (t) {
        ...
        return null == t ? e : this.add(t - e, "d")
    }, vn.hour = vn.hours = ne, vn.minute = vn.minutes = dn, vn.second = vn.seconds = pn, vn.millisecond = vn.milliseconds = gn, vn.utcOffset = function (t, e, i) {
        ...
        if (null != t) {
            ...
            return !this._isUTC && e && (s = Re(this)), this._offset = t, this._isUTC = !0, null != s && this.add(s, "m"), o !== t && (!e || this._changeInProgress ? Ge(this, qe(t - o, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, n.updateOffset(this, !0), this._changeInProgress = null)), this
        }
        ...
        return !!this.isValid() && this._isUTC
    }, vn.isUtc = We, vn.isUTC = We, vn.zoneAbbr = function () {
        return this._isUTC ? "UTC" : ""
    }, vn.zoneName = function () {
        return this._isUTC ? "Coordinated Universal Time" : ""
    }, vn.dates = C("dates accessor is deprecated. Use date instead.", un), vn.months = C("months accessor is deprecated. Use month instead", Lt), vn.years = C("years accessor is deprecated. Use year instead", Tt), vn.zone = C("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function (t, e) {
        return null != t ? ("string" != typeof t && (t = -t), this.utcOffset(t, e), this) : -this.utcOffset()
    }), vn.isDSTShifted = C("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", function () {
    ...
    }), n.lang = C("moment.lang is deprecated. Use moment.locale instead.", le), n.langData = C("moment.langData is deprecated. Use moment.localeData instead.", he);
    var kn = Math.abs;
    ...
    var Mn = En("ms"), An = En("s"), On = En("m"), In = En("h"), Nn = En("d"), Pn = En("w"), Ln = En("M"), jn = En("Q"),
        Yn = En("y");
    ...
    var $n = Hn("milliseconds"), Rn = Hn("seconds"), Wn = Hn("minutes"), Un = Hn("hours"), Fn = Hn("days"),
        qn = Hn("months"), Vn = Hn("years");
    var Bn = Math.round, zn = {ss: 44, s: 45, m: 45, h: 22, d: 26, M: 11};
    var Gn = Math.abs;
    ...
    function Qn() {
        ...
        var t, e, n = Gn(this._milliseconds) / 1e3, i = Gn(this._days), s = Gn(this._months);
        e = _((t = _(n / 60)) / 60), n %= 60, t %= 60;
        var o = _(s / 12), r = s %= 12, a = i, l = e, c = t, h = n ? n.toFixed(3).replace(/\.?0+$/, "") : "",
            u = this.asSeconds();
        if (!u) return "P0D";
        var d = u < 0 ? "-" : "", f = Kn(this._months) !== Kn(u) ? "-" : "", p = Kn(this._days) !== Kn(u) ? "-" : "",
    ...
    return Zn.isValid = function () {
    ...
    }, Zn.asMilliseconds = Mn, Zn.asSeconds = An, Zn.asMinutes = On, Zn.asHours = In, Zn.asDays = Nn, Zn.asWeeks = Pn, Zn.asMonths = Ln, Zn.asQuarters = jn, Zn.asYears = Yn, Zn.valueOf = function () {
        ...
        return o >= 0 && r >= 0 && a >= 0 || o <= 0 && r <= 0 && a <= 0 || (o += 864e5 * xn(Sn(a) + r), r = 0, a = 0), l.milliseconds = o % 1e3, t = _(o / 1e3), l.seconds = t % 60, e = _(t / 60), l.minutes = e % 60, n = _(e / 60), l.hours = n % 24, a += s = _(Tn(r += _(n / 24))), r -= xn(Sn(s)), i = _(a / 12), a %= 12, l.days = r, l.months = a, l.years = i, this
    }, Zn.clone = function () {
        return qe(this)
    }, Zn.get = function (t) {
        return t = N(t), this.isValid() ? this[t + "s"]() : NaN
    }, Zn.milliseconds = $n, Zn.seconds = Rn, Zn.minutes = Wn, Zn.hours = Un, Zn.days = Fn, Zn.weeks = function () {
        return _(this.days() / 7)
    }, Zn.months = qn, Zn.years = Vn, Zn.humanize = function (t) {
        if (!this.isValid()) return this.localeData().invalidDate();
        var e, n, i, s, o, r, a, l, c, h, u, d = this.localeData(),
            f = (n = !t, i = d, s = qe(e = this).abs(), o = Bn(s.as("s")), r = Bn(s.as("m")), a = Bn(s.as("h")), l = Bn(s.as("d")), c = Bn(s.as("M")), h = Bn(s.as("y")), (u = o <= zn.ss && ["s", o] || o < zn.s && ["ss", o] || r <= 1 && ["m"] || r < zn.m && ["mm", r] || a <= 1 && ["h"] || a < zn.h && ["hh", a] || l <= 1 && ["d"] || l < zn.d && ["dd", l] || c <= 1 && ["M"] || c < zn.M && ["MM", c] || h <= 1 && ["y"] || ["yy", h])[2] = n, u[3] = +e > 0, u[4] = i, function (t, e, n, i, s) {
                return s.relativeTime(e || 1, !!n, t, i)
            }.apply(null, u));
        return t && (f = d.pastFuture(+this, f)), d.postformat(f)
    }, Zn.toISOString = Qn, Zn.toString = Qn, Zn.toJSON = Qn, Zn.locale = Xe, Zn.localeData = tn, Zn.toIsoString = C("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Qn), Zn.lang = Je, U("X", 0, 0, "unix"), U("x", 0, 0, "valueOf"), lt("x", it), lt("X", /[+-]?\d+(\.\d{1,3})?/), dt("X", function (t, e, n) {
        n._d = new Date(1e3 * parseFloat(t, 10))
    }), dt("x", function (t, e, n) {
        n._d = new Date(w(t))
    }), n.version = "2.24.0", t = Ee, n.fn = vn, n.min = function () {
        return Oe("isBefore", [].slice.call(arguments, 0))
    }, n.max = function () {
        return Oe("isAfter", [].slice.call(arguments, 0))
    }, n.now = function () {
        return Date.now ? Date.now() : +new Date
    }, n.utc = u, n.unix = function (t) {
        return Ee(1e3 * t)
    }, n.months = function (t, e) {
        return wn(t, e, "months")
    }, n.isDate = a, n.locale = le, n.invalid = p, n.duration = qe, n.isMoment = b, n.weekdays = function (t, e, n) {
        return Dn(t, e, n, "weekdays")
    }, n.parseZone = function () {
        return Ee.apply(null, arguments).parseZone()
    }, n.localeData = he, n.isDuration = Pe, n.monthsShort = function (t, e) {
        return wn(t, e, "monthsShort")
    }, n.weekdaysMin = function (t, e, n) {
        return Dn(t, e, n, "weekdaysMin")
    }, n.defineLocale = ce, n.updateLocale = function (t, e) {
        if (null != e) {
            var n, i, s = ie;
    ...
    e.fn.extend({
        slimScroll: function (n) {
            ...
            return this.each(function () {
                var s, o, r, a, l, c, h, u, d = "<div></div>", f = 30, p = !1, m = e(this);
                if (m.parent().hasClass(i.wrapperClass)) {
                    ...
                    w.css(k), D.css(k), m.wrap(b), m.parent().append(D), m.parent().append(w), i.railDraggable && D.bind("mousedown", function (n) {
                        var i = e(document);
                        return r = !0, t = parseFloat(D.css("top")), pageY = n.pageY, i.bind("mousemove.slimscroll", function (e) {
                            currTop = t + e.pageY - pageY, D.css("top", currTop), x(0, D.position().top, !1)
                        ...
                        (p || t.originalEvent.preventDefault(), t.originalEvent.touches.length) && (x((l - t.originalEvent.touches[0].pageY) / i.touchScrollStep, !0), l = t.originalEvent.touches[0].pageY)
                    }), T(), "bottom" === i.start ? (D.css({top: m.outerHeight() - D.outerHeight()}), x(0, !0)) : "top" !== i.start && (x(e(i.start).position().top, null, !0), i.alwaysVisible || D.hide()), _ = this, window.addEventListener ? (_.addEventListener("DOMMouseScroll", C, !1), _.addEventListener("mousewheel", C, !1)) : document.attachEvent("onmousewheel", C)
                }
                ...
                function C(t) {
                    if (s) {
                        ...
                        e(o).closest("." + i.wrapperClass).is(m.parent()) && x(n, !0), t.preventDefault && !p && t.preventDefault(), p || (t.returnValue = !1)
                    }
                }

                function x(t, e, n) {
                    p = !1;
                    var s = t, o = m.outerHeight() - D.outerHeight();
                    if (e && (s = parseInt(D.css("top")) + t * parseInt(i.wheelStep) / 100 * D.outerHeight(), s = Math.min(Math.max(s, 0), o), s = t > 0 ? Math.ceil(s) : Math.floor(s), D.css({top: s + "px"})), s = (h = parseInt(D.css("top")) / (m.outerHeight() - D.outerHeight())) * (m[0].scrollHeight - m.outerHeight()), n) {
                        var r = (s = t) / m[0].scrollHeight * m.outerHeight();
                        r = Math.min(Math.max(r, 0), o), D.css({top: r + "px"})
                    }
                    m.scrollTop(s), m.trigger("slimscrolling", ~~s), S(), E()
                }
                ...
                function S() {
                    ...
                    u = h, c >= m.outerHeight() ? p = !0 : (D.stop(!0, !0).fadeIn("fast"), i.railVisible && w.stop(!0, !0).fadeIn("fast"))
                }
    ...
    var n = function (n, i, s) {
        ...
        if (void 0 === i.startDate && void 0 === i.endDate && e(this.element).is(":text")) {
            var h = e(this.element).val(), u = h.split(this.locale.separator);
            a = l = null, 2 == u.length ? (a = t(u[0], this.locale.format), l = t(u[1], this.locale.format)) : this.singleDatePicker && "" !== h && (a = t(h, this.locale.format), l = t(h, this.locale.format)), null !== a && null !== l && (this.setStartDate(a), this.setEndDate(l))
        }
    ...
    return n.prototype = {
        constructor: n, setStartDate: function (e) {
            ...
            var i, s = (i = "left" == n ? this.leftCalendar : this.rightCalendar).month.month(), o = i.month.year(),
                r = i.month.hour(), a = i.month.minute(), l = i.month.second(), c = t([o, s]).daysInMonth(),
                h = t([o, s, 1]), u = t([o, s, c]), d = t(h).subtract(1, "month").month(),
                f = t(h).subtract(1, "month").year(), p = t([f, d]).daysInMonth(), m = h.day();
            (i = []).firstDay = h, i.lastDay = u;
            for (var g = 0; g < 6; g++) i[g] = [];
            var v = p - m + this.locale.firstDay + 1;
            v > p && (v -= 7), m == this.locale.firstDay && (v = p - 6);
            for (var y = t([f, d, v, 12, a, l]), b = (g = 0, 0), _ = 0; g < 42; g++, b++, y = t(y).add(24, "hour")) g > 0 && b % 7 == 0 && (b = 0, _++), i[_][b] = y.clone().hour(r).minute(a).second(l), y.hour(12), this.minDate && i[_][b].format("YYYY-MM-DD") == this.minDate.format("YYYY-MM-DD") && i[_][b].isBefore(this.minDate) && "left" == n && (i[_][b] = this.minDate.clone()), this.maxDate && i[_][b].format("YYYY-MM-DD") == this.maxDate.format("YYYY-MM-DD") && i[_][b].isAfter(this.maxDate) && "right" == n && (i[_][b] = this.maxDate.clone());
            ...
            k += "<thead>", k += "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (k += "<th></th>"), w && !w.isBefore(i.firstDay) || this.linkedCalendars && "left" != n ? k += "<th></th>" : k += '<th class="prev available"><span></span></th>';
            ...
            if (this.showDropdowns) {
                ...
                O += "</select>";
                for (var N = '<select class="yearselect">', P = E; P <= S; P++) N += '<option value="' + P + '"' + (P === T ? ' selected="selected"' : "") + ">" + P + "</option>";
                C = O + (N += "</select>")
            }
            if (k += '<th colspan="5" class="month">' + C + "</th>", D && !D.isAfter(i.lastDay) || this.linkedCalendars && "right" != n && !this.singleDatePicker ? k += "<th></th>" : k += '<th class="next available"><span></span></th>', k += "</tr>", k += "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (k += '<th class="week">' + this.locale.weekLabel + "</th>"), e.each(this.locale.daysOfWeek, function (t, e) {
                k += "<th>" + e + "</th>"
            ...
            if ("right" != t || this.endDate) {
                ...
                if (!this.maxSpan || this.maxDate && !this.startDate.clone().add(this.maxSpan).isAfter(this.maxDate) || (s = this.startDate.clone().add(this.maxSpan)), "left" == t) n = this.startDate.clone(), i = this.minDate; else if ("right" == t) {
                ...
                if (!this.timePicker24Hour) {
                    ...
                    var p = "", m = "";
                    i && n.clone().hour(12).minute(0).second(0).isBefore(i) && (p = ' disabled="disabled" class="disabled"'), s && n.clone().hour(0).minute(0).second(0).isAfter(s) && (m = ' disabled="disabled" class="disabled"'), n.hour() >= 12 ? e += '<option value="AM"' + p + '>AM</option><option value="PM" selected="selected"' + m + ">PM</option>" : e += '<option value="AM" selected="selected"' + p + '>AM</option><option value="PM"' + m + ">PM</option>", e += "</select>"
                }
            ...
            var t, n = {top: 0, left: 0}, i = e(window).width();
            ...
            var n = e(t.target).closest(".drp-calendar").hasClass("left"), i = n ? "left" : "right",
                s = this.container.find(".drp-calendar." + i), o = parseInt(s.find(".monthselect").val(), 10),
                r = s.find(".yearselect").val();
            n || (r < this.startDate.year() || r == this.startDate.year() && o < this.startDate.month()) && (o = this.startDate.month(), r = this.startDate.year()), this.minDate && (r < this.minDate.year() || r == this.minDate.year() && o < this.minDate.month()) && (o = this.minDate.month(), r = this.minDate.year()), this.maxDate && (r > this.maxDate.year() || r == this.maxDate.year() && o > this.maxDate.month()) && (o = this.maxDate.month(), r = this.maxDate.year()), n ? (this.leftCalendar.month.month(o).year(r), this.linkedCalendars && (this.rightCalendar.month = this.leftCalendar.month.clone().add(1, "month"))) : (this.rightCalendar.month.month(o).year(r), this.linkedCalendars && (this.leftCalendar.month = this.rightCalendar.month.clone().subtract(1, "month"))), this.updateCalendars()
        }, timeChanged: function (t) {
            var n = e(t.target).closest(".drp-calendar"), i = n.hasClass("left"),
                s = parseInt(n.find(".hourselect").val(), 10), o = parseInt(n.find(".minuteselect").val(), 10),
            ...
            if (this.element.is("input") && this.element.val().length) {
                var e = this.element.val().split(this.locale.separator), n = null, i = null;
    ...
    return i = "metisMenu", o = "." + (s = "metisMenu"), r = (n = t).fn[i], a = {
        toggle: !0,
        preventDefault: !0,
        activeClass: "active",
        ...
        return i.init = function () {
            ...
            n(this.element).find(e.parentTrigger + "." + e.activeClass).has(e.subMenu).children(e.subMenu).attr("aria-expanded", !0).addClass(e.collapseClass + " " + e.collapseInClass), n(this.element).find(e.parentTrigger).not("." + e.activeClass).has(e.subMenu).children(e.subMenu).attr("aria-expanded", !1).addClass(e.collapseClass), n(this.element).find(e.parentTrigger).has(e.subMenu).children(e.triggerElement).on(l.CLICK_DATA_API, function (i) {
                var s = n(this), o = s.parent(e.parentTrigger),
                    r = o.siblings(e.parentTrigger).children(e.triggerElement), a = o.children(e.subMenu);
                e.preventDefault && i.preventDefault(), "true" !== s.attr("aria-disabled") && (o.hasClass(e.activeClass) ? (s.attr("aria-expanded", !1), t.hide(a)) : (t.show(a), s.attr("aria-expanded", !0), e.toggle && r.attr("aria-expanded", !1)), e.onTransitionStart && e.onTransitionStart(i))
            })
        }, i.show = function (t) {
            var e = this;
            if (!this.transitioning && !n(t).hasClass(this.config.collapsingClass)) {
                var i = n(t), s = n.Event(l.SHOW);
            ...
            return this.each(function () {
                var o = n(this), r = o.data(s), l = e({}, a, o.data(), "object" == typeof i && i ? i : {});
        ...
        return n.fn[i] = r, c.jQueryInterface
    }, c
    ...
    var s = {
        ...
        setup: function () {
            var e = "";
            if (this._toastEl = this._toastEl || t("<div></div>", {class: "jq-toast-single"}), e += '<span class="jq-toast-loader"></span>', this.options.allowToastClose && (e += '<span class="close-jq-toast-single">&times;</span>'), this.options.text instanceof Array) {
        ...
        addToDom: function () {
            ...
            if (0 === e.length ? (e = t("<div></div>", {class: "jq-toast-wrap"}), t("body").append(e)) : (!this.options.stack || isNaN(parseInt(this.options.stack, 10))) && e.empty(), e.find(".jq-toast-single:hidden").remove(), e.append(this._toastEl), this.options.stack && !isNaN(parseInt(this.options.stack), 10)) {
        ...
        processLoader: function () {
            ...
            var t = this._toastEl.find(".jq-toast-loader"), e = (this.options.hideAfter - 400) / 1e3 + "s",
                n = this.options.loaderBg, i = t.attr("style") || "";
    ...
    var e = function () {
        ...
        return e && e.requirejs || (e ? i = e : e = {}, function (t) {
            ...
            function o(t, e) {
                var n, i, s, o, r, a, l, c, h, u, d, f = e && e.split("/"), p = v.map, m = p && p["*"] || {};
                if (t) {
                    for (r = (t = t.split("/")).length - 1, v.nodeIdCompat && w.test(t[r]) && (t[r] = t[r].replace(w, "")), "." === t[0].charAt(0) && f && (t = f.slice(0, f.length - 1).concat(t)), h = 0; h < t.length; h++) if ("." === (d = t[h])) t.splice(h, 1), h -= 1; else if (".." === d) {
            ...
            var u, d, f, p, m = {}, g = {}, v = {}, y = {}, b = Object.prototype.hasOwnProperty, _ = [].slice,
                w = /\.js$/;
            f = function (t, e) {
                var n, i, s = c(t), r = s[0], a = e[1];
                return t = s[1], r && (n = l(r = o(r, a))), r ? t = n && n.normalize ? n.normalize(t, (i = a, function (t) {
                    return o(t, i)
                ...
                var c, u, d, v, b, _, w, D = [], k = typeof s;
                if (_ = h(o = o || n), "undefined" === k || "function" === k) {
                    for (i = !i.length && s.length ? ["require", "exports", "module"] : i, b = 0; b < i.length; b += 1) if ("require" === (u = (v = f(i[b], _)).f)) D[b] = p.require(n); else if ("exports" === u) D[b] = p.exports(n), w = !0; else if ("module" === u) c = D[b] = p.module(n); else if (e(m, u) || e(g, u) || e(y, u)) D[b] = l(u); else {
                        if (!v.p) throw new Error(n + " missing " + u);
                        v.p.load(v.n, r(o, !0), a(u), {}), D[b] = m[u]
                    }
                    d = s ? s.apply(m[n], D) : void 0, n && (c && c.exports !== t && c.exports !== m[n] ? m[n] = c.exports : d === t && w || (m[n] = d))
                } else n && (m[n] = s)
                ...
                return n = n || function () {
                }, "function" == typeof i && (i = s, s = o), s ? u(t, e, n, i) : setTimeout(function () {
                    u(t, e, n, i)
                }, 4), d
            }, d.config = function (t) {
                return d(t)
        ...
        }(), e.requirejs = n, e.require = i, e.define = s), e.define("almond", function () {
            ...
            var n = {
                Extend: function (t, e) {
                    ...
                    function i() {
                        var e = Array.prototype.unshift, i = n.prototype.constructor.length,
            ...
            i.prototype.on = function (t, e) {
                ...
                var i = t(n), s = n.style.overflowX, o = n.style.overflowY;
            ...
            return e.Extend(n, e.Observable), n.prototype.render = function () {
                ...
                this.data.current(function (i) {
                    ...
                    n.$results.find(".select2-results__option[aria-selected]").each(function () {
                        var n = t(this), i = e.GetData(this, "data"), o = "" + i.id;
                ...
                this.$results.attr("id", o), n.on("results:all", function (t) {
                    ...
                    if (0 !== t.length) {
                        ...
                        "true" == t.attr("aria-selected") ? s.trigger("close", {}) : s.trigger("select", {data: n})
                    }
                }), n.on("results:previous", function () {
                    var t = s.getHighlightedResults(), e = s.$results.find("[aria-selected]"), n = e.index(t);
                    if (!(n <= 0)) {
                        var i = n - 1;
                        0 === t.length && (i = 0);
                        var o = e.eq(i);
                        o.trigger("mouseenter");
                        var r = s.$results.offset().top, a = o.offset().top, l = s.$results.scrollTop() + (a - r);
                        0 === i ? s.$results.scrollTop(0) : a - r < 0 && s.$results.scrollTop(l)
                    }
                }), n.on("results:next", function () {
                    var t = s.getHighlightedResults(), e = s.$results.find("[aria-selected]"), n = e.index(t) + 1;
                    if (!(n >= e.length)) {
                        var i = e.eq(n);
                        i.trigger("mouseenter");
                        var o = s.$results.offset().top + s.$results.outerHeight(!1),
                            r = i.offset().top + i.outerHeight(!1), a = s.$results.scrollTop() + r - o;
                    ...
                    var e = s.$results.scrollTop(), n = s.$results.get(0).scrollHeight - e + t.deltaY,
                        i = t.deltaY > 0 && e - t.deltaY <= 0, o = t.deltaY < 0 && n <= s.$results.height();
                ...
                if (0 !== t.length) {
                    var e = this.$results.find("[aria-selected]").index(t), n = this.$results.offset().top,
                        i = t.offset().top, s = this.$results.scrollTop() + (i - n), o = i - n;
                    s -= 2 * t.outerHeight(!1), e <= 2 ? this.$results.scrollTop(0) : (o > this.$results.outerHeight() || o < 0) && this.$results.scrollTop(s)
                }
            }, n.prototype.template = function (e, n) {
                var i = this.options.get("templateResult"), s = this.options.get("escapeMarkup"), o = i(e, n);
            ...
            return n.Extend(i, e), i.prototype.render = function () {
                ...
                i.__super__.bind.apply(this, arguments), this.$selection.on("click", function (t) {
                    ...
                    if (!o.options.get("disabled")) {
                        var i = t(this).parent(), s = n.GetData(i[0], "data");
                ...
                if (this.clear(), 0 !== t.length) {
                    for (var e = [], i = 0; i < t.length; i++) {
                        var s = t[i], o = this.selectionContainer(), r = this.display(s, o);
                        o.append(r), o.attr("title", s.title || s.text), n.StoreData(o[0], "data", s), e.push(o)
                    }
            ...
            return i.prototype.bind = function (t, e, n) {
                ...
                if (!this.options.get("disabled")) {
                    ...
                    if (0 !== i.length) {
                        e.stopPropagation();
                        var s = n.GetData(i[0], "data"), o = this.$element.val();
            ...
            return i.prototype.render = function (e) {
                ...
                this.$selection.on("input.searchcheck", ".select2-search--inline", function (t) {
                    ...
                    if (a && "input" === t.type) o.$selection.off("input.search input.searchcheck"); else {
                        var e = t.which;
            ...
            return e.prototype.bind = function (e, n, i) {
                ...
                e.call(this, n, i), n.on("*", function (e, n) {
                    if (-1 !== t.inArray(e, o)) {
                        ...
                        s.$element.trigger(i), -1 !== t.inArray(e, r) && (n.prevented = i.isDefaultPrevented())
                    }
                })
            }, e
            ...
            return e.Extend(i, t), i.prototype.current = function (t) {
                ...
                var s = n(i), o = this._normalizeItem(t);
                return o.element = i, e.StoreData(i, "data", o), s
            ...
            return e.Extend(i, t), i.prototype.select = function (t) {
                ...
                for (var s = this, o = this.$element.find("option"), r = o.map(function () {
                    ...
                    if (n.inArray(c.id, r) >= 0) {
                        var h = o.filter(i(c)), u = this.item(h), d = n.extend(!0, {}, c, u), f = this.option(d);
                        h.replaceWith(f)
                    } else {
                        var p = this.option(c);
                        if (c.children) {
            ...
            return e.Extend(i, t), i.prototype._applyDefaults = function (t) {
                ...
                function i() {
                    var i = o.transport(o, function (i) {
                        ...
                        s.options.get("debug") && window.console && console.error && (o && o.results && n.isArray(o.results) || console.error("Select2: The AJAX results did not return an array in the `results` key of the response.")), e(o)
                    }, function () {
            ...
            function e(e, n, i) {
                ...
                if (void 0 !== r && (this.insertTag = r), e.call(this, n, i), t.isArray(s)) for (var a = 0; a < s.length; a++) {
                    var l = s[a], c = this._normalizeItem(l), h = this.option(c);
            ...
            return e.prototype.query = function (t, e, n) {
                ...
                this._removeOldTags(), null != e.term && null == e.page ? t.call(this, e, function t(s, o) {
                    ...
                    if (null != h) {
                        var u = i.option(h);
                        u.attr("data-select2-tag", !0), i.addOptions([u]), i.insertTag(r, h)
                    }
                    s.results = r, n(s)
                }) : t.call(this, e, n)
            ...
            return e.prototype.bind = function (t, e, n) {
                ...
                for (var o = i.get("tokenSeparators") || [], r = n.term, a = 0, l = this.createTag || function (t) {
                    ...
                    var c = r[a];
                    if (-1 !== t.inArray(c, o)) {
                        var h = r.substr(0, a), u = l(t.extend({}, n, {term: h}));
            ...
            return n.prototype.bind = function (t, e, n) {
                ...
                var s = this, o = "scroll.select2." + i.id, r = "resize.select2." + i.id,
                ...
                var s = "scroll.select2." + i.id, o = "resize.select2." + i.id, r = "orientationchange.select2." + i.id;
                ...
                var e = t(window), n = this.$dropdown.hasClass("select2-dropdown--above"),
                    i = this.$dropdown.hasClass("select2-dropdown--below"), s = null, o = this.$container.offset();
        ...
        }), e.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function (t, e, n, i, s, o, r, a, l, c, h, u, d, f, p, m, g, v, y, b, _, w, D, k, C, x, T, S, E) {
            function M() {
                this.reset()
            }
            ...
            return M.prototype.apply = function (u) {
                ...
                if (t.isArray(u.language)) {
                    var P = new h;
                    u.language.push("en");
                    for (var L = u.language, j = 0; j < L.length; j++) {
                        var Y = L[j], H = {};
                        try {
                            H = h.loadPath(Y)
                        } catch (t) {
                            try {
                                Y = this.defaults.amdLanguageBase + Y, H = h.loadPath(Y)
                            } catch (t) {
                    ...
                    var $ = h.loadPath(this.defaults.amdLanguageBase + "en"), R = new h(u.language);
                    R.extend($), u.translations = R
                }
                return u
                ...
                this.defaults = {
                    ...
                    matcher: function n(i, s) {
                        ...
                        if (s.children && s.children.length > 0) {
                            for (var o = t.extend(!0, {}, s), r = s.children.length - 1; r >= 0; r--) null == n(i, s.children[r]) && o.children.splice(r, 1);
                            return o.children.length > 0 ? o : n(i, o)
                        }
                        var a = e(s.text).toUpperCase(), l = e(i.term).toUpperCase();
            ...
            return n.Extend(s, n.Observable), s.prototype._generateId = function (t) {
                ...
                if (void 0 === e && (e = {}), t in i) {
                    var o = i[t], r = {prevented: !1, name: t, args: e};
...
var $jscomp = {
    scope: {}, findInternal: function (t, e, n) {
        ...
        for (var i = t.length, s = 0; s < i; s++) {
            var o = t[s];
            if (e.call(n, o, s, t)) return {i: s, v: o}
        }
        return {i: -1, v: void 0}
    }
};
$jscomp.defineProperty = "function" == typeof Object.defineProperties ? Object.defineProperty : function (t, e, n) {
    ...
    var e = function (e, n, i) {
        var s = {
            invalid: [], getCaret: function () {
                ...
                return o = o.join(""), s && (o = o.replace(new RegExp("(" + s.digit + "(.*" + s.digit + ")?)"), "($1)?").replace(new RegExp(s.digit, "g"), s.pattern)), new RegExp(o)
                ...
                var t = e.data("mask-previus-value") || "", n = s.getMasked(), i = s.getCaret();
                if (t !== n) {
                    var o, r = e.data("mask-previus-caret-pos") || 0, a = (n = n.length, t.length), l = t = 0, c = 0,
                        h = 0;
                ...
                if (-1 === t.inArray(i, r.byPassKeys)) {
                    ...
                    }, t.jMaskGlobals.keyStrokeCompensation), s.val(i), s.setCaret(o), s.callbacks(n)
                }
            }, getMasked: function (t, e) {
                var o, a, l, c = [], h = void 0 === e ? s.val() : e + "", u = 0, d = n.length, f = 0, p = h.length,
                    m = 1, g = "push", v = -1, y = 0, b = [];
                for (i.reverse ? (g = "unshift", m = -1, o = 0, u = d - 1, f = p - 1, a = function () {
                    return -1 < u && -1 < f
                }) : (o = d - 1, a = function () {
                    return u < d && f < p
                }); a();) {
                    var _ = n.charAt(u), w = h.charAt(f), D = r.translation[_];
                ...
                return h = n.charAt(o), d !== p + 1 || r.translation[h] || c.push(h), c = c.join(""), s.mapMaskdigitPositions(c, b, p), c
                ...
                var o = s.val(), r = o !== a, l = [o, t, e, i], c = function (t, e, n) {
                    "function" == typeof i[t] && e && i[t].apply(this, n)
                };
                c("onChange", !0 === r, l), c("onKeyPress", !0 === r, l), c("onComplete", o.length === n.length, l), c("onInvalid", 0 < s.invalid.length, [o, t, e, s.invalid, i])
            }
        };
        e = t(e);
        var o, r = this, a = s.val();
        n = "function" == typeof n ? n(s.val(), void 0, e, i) : n, r.mask = n, r.options = i, r.remove = function () {
            var t = s.getCaret();
            return r.options.placeholder && e.removeAttr("placeholder"), e.data("mask-maxlength") && e.removeAttr("maxlength"), s.destroyEvents(), s.val(r.getCleanVal()), s.setCaret(t), e
    ...
    t.maskWatchers = {};
    var n = function () {
        var n = t(this), s = {}, o = n.attr("data-mask");
        ...
        i = i || {};
        var s = t(e).data("mask"), o = JSON.stringify;
        e = t(e).val() || t(e).text();
        try {
            return "function" == typeof n && (n = n(e)), "object" != typeof s || o(s.options) !== o(i) || s.mask !== n
        } catch (t) {
        }
    }, s = function (t) {
    ...
    t.fn.mask = function (n, s) {
        s = s || {};
        var o = this.selector, r = (a = t.jMaskGlobals).watchInterval, a = s.watchInputs || a.watchInputs,
            l = function () {
        ...
        return this.each(function (n) {
            if (!(n = t(this)).data("bootstrapWizard")) {
                var i = new function (e, n) {
                    e = t(e);
                    var i = this, s = [], o = t.extend({}, t.fn.bootstrapWizard.defaults, n), r = null, a = null;
                    this.rebindClick = function (t, e) {
                        ...
                        var t = s.pop();
                        if (o.onBack && "function" == typeof o.onBack && !1 === o.onBack(r, a, t)) return s.push(t), !1;
                    ...
                    var l = function (e) {
                        ...
                        r = $element, i.fixNavigationButtons()
                    };
                    this.resetWizard = function () {
                        t('a[data-toggle="tab"]', a).off("click", l), t('a[data-toggle="tab"]', a).off("shown shown.bs.tab", c), a = e.find("ul:first", e), r = a.find('li:has([data-toggle="tab"]).active', e), t('a[data-toggle="tab"]', a).on("click", l), t('a[data-toggle="tab"]', a).on("shown shown.bs.tab", c), i.fixNavigationButtons()
                    }, a = e.find("ul:first", e), r = a.find('li:has([data-toggle="tab"]).active', e), a.hasClass(o.tabClass) || a.addClass(o.tabClass), o.onInit && "function" == typeof o.onInit && o.onInit(r, a, 0), o.onShow && "function" == typeof o.onShow && o.onShow(r, a, i.nextIndex()), t('a[data-toggle="tab"]', a).on("click", l), t('a[data-toggle="tab"]', a).on("shown shown.bs.tab", c)
                }(n, e);
    ...
    i.prototype = {
        constructor: i, _init: function () {
            ...
            if (n.selection) {
                t.focus();
                var e = n.selection.createRange(), i = n.selection.createRange().text.length;
            ...
            if (!this.disableMousewheel) {
                ...
                var n = e.originalEvent.wheelDelta || -e.originalEvent.detail, i = null;
            ...
            if (!this.isInline) {
                var n = this.$widget.outerWidth(), i = this.$widget.outerHeight(), s = t(e).width(), o = t(e).height(),
                    r = t(e).scrollTop(), a = parseInt(this.$element.parents().filter(function () {
                        return "auto" !== t(this).css("z-index")
                    }).first().css("z-index"), 10) + 10,
                    l = this.component ? this.component.parent().offset() : this.$element.offset(),
                    c = this.component ? this.component.outerHeight(!0) : this.$element.outerHeight(!1),
                    h = this.component ? this.component.outerWidth(!0) : this.$element.outerWidth(!1), u = l.left,
                    d = l.top;
                this.$widget.removeClass("timepicker-orient-top timepicker-orient-bottom timepicker-orient-right timepicker-orient-left"), "auto" !== this.orientation.x ? (this.$widget.addClass("timepicker-orient-" + this.orientation.x), "right" === this.orientation.x && (u -= n - h)) : (this.$widget.addClass("timepicker-orient-left"), l.left < 0 ? u -= l.left - 10 : l.left + n > s && (u = s - n - 10));
                var f, p, m = this.orientation.y;
                "auto" === m && (f = -r + l.top - i, p = r + o - (l.top + c + i), m = Math.max(f, p) === p ? "top" : "bottom"), this.$widget.addClass("timepicker-orient-" + m), "top" === m ? d += c : d -= i + parseInt(this.$widget.css("padding-top"), 10), this.$widget.css({
                    top: d,
                    left: u,
                    zIndex: a
                })
            ...
            if (this.$element.val()) this.updateFromElementVal(); else if ("current" === t) {
                var e = new Date, n = e.getHours(), i = e.getMinutes(), s = e.getSeconds(), o = "AM";
                0 !== s && (60 === (s = Math.ceil(e.getSeconds() / this.secondStep) * this.secondStep) && (i += 1, s = 0)), 0 !== i && (60 === (i = Math.ceil(e.getMinutes() / this.minuteStep) * this.minuteStep) && (n += 1, i = 0)), this.showMeridian && (0 === n ? n = 12 : n >= 12 ? (n > 12 && (n -= 12), o = "PM") : o = "AM"), this.hour = n, this.minute = i, this.second = s, this.meridian = o, this.update()
            ...
            if (t) {
                ...
                if ("object" == typeof t && t.getMonth) s = t.getHours(), o = t.getMinutes(), r = t.getSeconds(), this.showMeridian && (a = "AM", s > 12 && (a = "PM", s %= 12), 12 === s && (a = "PM")); else {
                    ...
                    o = i[1] ? i[1].toString() : "", r = i[2] ? i[2].toString() : "", s.length > 4 && (r = s.slice(-2), s = s.slice(0, -2)), s.length > 2 && (o = s.slice(-2), s = s.slice(0, -2)), o.length > 2 && (r = o.slice(-2), o = o.slice(0, -2)), s = parseInt(s, 10), o = parseInt(o, 10), r = parseInt(r, 10), isNaN(s) && (s = 0), isNaN(o) && (o = 0), isNaN(r) && (r = 0), r > 59 && (r = 59), o > 59 && (o = 59), s >= this.maxHours && (s = this.maxHours - 1), this.showMeridian ? (s > 12 && (n = 2, s -= 12), n || (n = 1), 0 === s && (s = 12), a = 1 === n ? "AM" : "PM") : 12 > s && 2 === n ? s += 12 : s >= this.maxHours ? s = this.maxHours - 1 : (0 > s || 12 === s && 1 === n) && (s = 0)
                }
            ...
            this.isOpen || this.$element.is(":disabled") || (this.$widget.appendTo(this.appendWidgetTo), t(n).on("mousedown.timepicker, touchend.timepicker", {scope: this}, this.handleDocumentClick), this.$element.trigger({
            ...
            var n = t(e.target), i = n.closest("a").data("action");
            i && this[i](), this.update(), n.is("input") && n.get(0).setSelectionRange(0, 2)
        }, widgetKeydown: function (e) {
            var n = t(e.target), i = n.attr("class").replace("bootstrap-timepicker-", "");
            switch (e.which) {
                case 9:
                    if (e.shiftKey) {
        ...
        return n.shift(), this.each(function () {
            ...
            o || s.data("timepicker", o = new i(this, t.extend({}, t.fn.timepicker.defaults, r, t(this).data()))), "string" == typeof e && o[e].apply(o, n)
        })
    ...
    t.fn.TouchSpin = function (n) {
        ...
        return this.each(function () {
            var o, r, a, l, c, h, u, d, f, p, m = t(this), g = m.data(), v = 0, y = !1;

            function b() {
                "" === o.prefix && (r = c.prefix.detach()), "" === o.postfix && (a = c.postfix.detach())
            }
            ...
            function w() {
                if (o.booster) {
                    ...
                    return o.maxboostedstep && t > o.maxboostedstep && (t = o.maxboostedstep, h = Math.round(h / t) * t), Math.max(o.step, t)
                }
                return o.step
            }

            function D() {
                _(), h = parseFloat(o.callback_before_calculation(c.input.val())), isNaN(h) && (h = 0);
                var t = h, e = w();
                h += e, null !== o.max && h > o.max && (h = o.max, m.trigger("touchspin.on.max"), T()), c.input.val(o.callback_after_calculation(Number(h).toFixed(o.decimals))), t !== h && m.trigger("change")
            }

            function k() {
                _(), h = parseFloat(o.callback_before_calculation(c.input.val())), isNaN(h) && (h = 0);
                var t = h, e = w();
                h -= e, null !== o.min && h < o.min && (h = o.min, m.trigger("touchspin.on.min"), T()), c.input.val(o.callback_after_calculation(Number(h).toFixed(o.decimals))), t !== h && m.trigger("change")
            }

            function C() {
                T(), v = 0, y = "down", m.trigger("touchspin.on.startspin"), m.trigger("touchspin.on.startdownspin"), f = setTimeout(function () {
            ...
            function x() {
                T(), v = 0, y = "up", m.trigger("touchspin.on.startspin"), m.trigger("touchspin.on.startupspin"), p = setTimeout(function () {
            ...
            !function () {
                var h, u, d, f, p;
                if (!m.data("alreadyinitialized")) m.data("alreadyinitialized", !0), e += 1, m.data("spinnerid", e), m.is("input") ? ("" !== (o = t.extend({}, i, g, (p = {}, t.each(s, function (t, e) {
                    var n = "bts-" + e;
                    m.is("[data-" + n + "]") && (p[t] = m.data(n))
                }), p), n)).initval && "" === m.val() && m.val(o.initval), _(), d = m.val(), f = m.parent(), "" !== d && (d = o.callback_after_calculation(Number(d).toFixed(o.decimals))), m.data("initvalue", d).val(d), m.addClass("form-control"), f.hasClass("input-group") ? function (e) {
                    e.addClass("bootstrap-touchspin");
                    var n, i, s = m.prev(), r = m.next(),
                    ...
                    s.hasClass("input-group-btn") || s.hasClass("input-group-prepend") ? (n = '<button class="' + o.buttondown_class + ' bootstrap-touchspin-down bootstrap-touchspin-injected" type="button">' + o.buttondown_txt + "</button>", s.append(n)) : (n = '<span class="input-group-btn input-group-prepend bootstrap-touchspin-injected"><button class="' + o.buttondown_class + ' bootstrap-touchspin-down" type="button">' + o.buttondown_txt + "</button></span>", t(n).insertBefore(m)), r.hasClass("input-group-btn") || r.hasClass("input-group-append") ? (i = '<button class="' + o.buttonup_class + ' bootstrap-touchspin-up bootstrap-touchspin-injected" type="button">' + o.buttonup_txt + "</button>", r.prepend(i)) : (i = '<span class="input-group-btn input-group-append bootstrap-touchspin-injected"><button class="' + o.buttonup_class + ' bootstrap-touchspin-up" type="button">' + o.buttonup_txt + "</button></span>", t(i).insertAfter(m)), t(a).insertBefore(m), t(c).insertAfter(m), l = e
                    ...
                    _(), m.val(o.callback_after_calculation(m.val()))
                    ...
                    c.down.off("touchstart.touchspin"), m.is(":disabled") || (k(), C(), t.preventDefault(), t.stopPropagation())
                }), c.down.on("touchstart.touchspin", function (t) {
                    c.down.off("mousedown.touchspin"), m.is(":disabled") || (k(), C(), t.preventDefault(), t.stopPropagation())
                }), c.up.on("mousedown.touchspin", function (t) {
                    c.up.off("touchstart.touchspin"), m.is(":disabled") || (D(), x(), t.preventDefault(), t.stopPropagation())
                }), c.up.on("touchstart.touchspin", function (t) {
                    c.up.off("mousedown.touchspin"), m.is(":disabled") || (D(), x(), t.preventDefault(), t.stopPropagation())
                    ...
                    if (o.mousewheel && m.is(":focus")) {
                        ...
                        t.stopPropagation(), t.preventDefault(), e < 0 ? k() : D()
                    }
                }), m.on("touchspin.destroy", function () {
                    var e;
                    e = m.parent(), T(), m.off(".touchspin"), e.hasClass("bootstrap-touchspin-injected") ? (m.siblings().remove(), m.unwrap()) : (t(".bootstrap-touchspin-injected", e).remove(), e.removeClass("bootstrap-touchspin")), m.data("alreadyinitialized", !1)
                    ...
                    !function (e) {
                        (function (e) {
                            (o = t.extend({}, o, e), e.postfix) && (0 === m.parent().find(".bootstrap-touchspin-postfix").length && a.insertAfter(m), m.parent().find(".bootstrap-touchspin-postfix .input-group-text").text(e.postfix));
    ...
    t.event.special.destroyed || (t.event.special.destroyed = {
        ...
        maxlength: function (e, n) {
            ...
            function l(n, i) {
                var s, o,
                    r = (o = (s = n)[0], t.extend({}, "function" == typeof o.getBoundingClientRect ? o.getBoundingClientRect() : {
                        width: o.offsetWidth,
                        height: o.offsetHeight
                    }, s.offset()));
                if ("function" !== t.type(e.placement)) if (t.isPlainObject(e.placement)) !function (n, i) {
                    if (n && i) {
                        var s = {};
                    ...
                    var a = n.outerWidth(), l = i.outerWidth(), c = i.width(), h = i.height();
                    switch (e.appendToParent && (r.top -= n.parent().offset().top, r.left -= n.parent().offset().left), e.placement) {
                        case"bottom":
                            i.css({top: r.top + r.height, left: r.left + r.width / 2 - c / 2});
                            break;
                        case"top":
                            i.css({top: r.top - h, left: r.left + r.width / 2 - c / 2});
                            break;
                        case"left":
                            i.css({top: r.top + r.height / 2 - h / 2, left: r.left - c});
                            break;
                        case"right":
                            i.css({top: r.top + r.height / 2 - h / 2, left: r.left + r.width});
                            break;
                        case"bottom-right":
                            i.css({top: r.top + r.height, left: r.left + r.width});
                            break;
                        case"top-right":
                            i.css({top: r.top - h, left: r.left + a});
                            break;
                        case"top-left":
                            i.css({top: r.top - h, left: r.left - l});
                            break;
                        case"bottom-left":
                            i.css({top: r.top + n.outerHeight(), left: r.left - l});
                            break;
                        case"centered-right":
                            i.css({top: r.top + h / 2, left: r.left + a - l - 3});
                            break;
                        case"bottom-right-inside":
                            i.css({top: r.top + r.height, left: r.left + r.width - l});
                            break;
                        case"top-right-inside":
                            i.css({top: r.top - h, left: r.left + a - l});
                            break;
                        case"top-left-inside":
                            i.css({top: r.top - h, left: r.left});
                            break;
                        case"bottom-left-inside":
                            i.css({top: r.top + n.outerHeight(), left: r.left})
                    }
            ...
            return t.isFunction(e) && !n && (n = e, e = {}), e = t.extend({
                ...
                function n() {
                    var n = r(u.val(), i, "0");
                    i = c(u), o || (o = t('<span class="bootstrap-maxlength"></span>').css({
                        display: "none",
                        position: "absolute",
                        whiteSpace: "nowrap",
                        zIndex: 1099
                    }).html(n)), u.is("textarea") && (u.data("maxlenghtsizex", u.outerWidth()), u.data("maxlenghtsizey", u.outerHeight()), u.mouseup(function () {
                        (u.outerWidth() !== u.data("maxlenghtsizex") || u.outerHeight() !== u.data("maxlenghtsizey")) && l(u, o), u.data("maxlenghtsizex", u.outerWidth()), u.data("maxlenghtsizey", u.outerHeight())
                    })), e.appendToParent ? (u.parent().append(o), u.parent().css("position", "relative")) : h.append(o), a(s(u, c(u)), u, i, o), l(u, o)
                }

                var i, o, u = t(this);
                t(window).resize(function () {
                    o && l(u, o)
                }), e.allowOverMax && (t(this).attr("data-bs-mxl", t(this).attr("maxlength")), t(this).removeAttr("maxlength")), e.showOnReady ? u.ready(function () {
                    n()
                }) : u.focus(function () {
                    n()
                }), u.on("maxlength.reposition", function () {
                    l(u, o)
                    ...
                    var t, n, r, h, d = c(u), f = s(u, d), p = !0;
                    return e.validate && 0 > f ? (n = d, r = (t = u).val(), h = 0, e.twoCharLinebreak && "\n" === (r = r.replace(/\r(?!\n)|\n(?!\r)/g, "\r\n")).substr(r.length - 1) && r.length % 2 == 1 && (h = 1), t.val(r.substr(0, n - h)), p = !1) : a(f, u, i, o), ("bottom-right-inside" === e.placement || "top-right-inside" === e.placement) && l(u, o), p
                })
            })
        }
    })
    ...
    l.prototype = {
        ...
        _process_options: function (e) {
            ...
            if (s.defaultViewDate instanceof Date || "string" == typeof s.defaultViewDate) s.defaultViewDate = m.parseDate(s.defaultViewDate, r, s.language, s.assumeNearbyYear); else if (s.defaultViewDate) {
                var c = s.defaultViewDate.year || (new Date).getFullYear(), h = s.defaultViewDate.month || 0,
        ...
        _buildEvents: function () {
            ...
            !0 === this.o.showOnFocus && (e.focus = t.proxy(this.show, this)), this.isInput ? this._events = [[this.element, e]] : this.component && this.inputField.length ? this._events = [[this.inputField, e], [this.component, {click: t.proxy(this.show, this)}]] : this._events = [[this.element, {
        ...
        _trigger: function (e, n) {
            var i = n || this.dates.get(-1), s = this._utc_to_local(i);
        ...
        place: function () {
            ...
            var e = this.picker.outerWidth(), n = this.picker.outerHeight(), i = t(this.o.container), s = i.width(),
                o = "body" === this.o.container ? t(document).scrollTop() : i.scrollTop(), r = i.offset(), a = [0];
            ...
            var l = Math.max.apply(Math, a) + this.o.zIndexOffset,
                ...
                u = this.component ? this.component.outerWidth(!0) : this.element.outerWidth(!1), d = c.left - r.left,
                f = c.top - r.top;
        ...
        getClassNames: function (e) {
            var n = [], o = this.viewDate.getUTCFullYear(), r = this.viewDate.getUTCMonth(), a = i();
        ...
        _fill_yearsView: function (n, i, s, o, r, a, l) {
            for (var c, h, u, d = "", f = s / 10, p = this.picker.find(n), m = Math.floor(o / s) * s, g = m + 9 * f, v = Math.floor(this.viewDate.getFullYear() / f) * f, y = t.map(this.dates, function (t) {
                return Math.floor(t.getUTCFullYear() / f) * f
            }), b = m - f; b <= g + f; b += f) c = [i], h = null, b === m - f ? c.push("old") : b === g + f && c.push("new"), -1 !== t.inArray(b, y) && c.push("active"), (b < r || b > a) && c.push("disabled"), b === v && c.push("focused"), l !== t.noop && ((u = l(new Date(b, 0, 1))) === e ? u = {} : "boolean" == typeof u ? u = {enabled: u} : "string" == typeof u && (u = {classes: u}), !1 === u.enabled && c.push("disabled"), u.classes && (c = c.concat(u.classes.split(/\s+/))), u.tooltip && (h = u.tooltip)), d += '<span class="' + c.join(" ") + '"' + (h ? ' title="' + h + '"' : "") + ">" + b + "</span>";
            p.find(".datepicker-switch").text(m + "-" + g), p.find("td").html(d)
        },
        fill: function () {
            var i, s, o = new Date(this.viewDate), r = o.getUTCFullYear(), a = o.getUTCMonth(),
                ...
                d = p[this.o.language].today || p.en.today || "", f = p[this.o.language].clear || p.en.clear || "",
                g = p[this.o.language].titleFormat || p.en.titleFormat;
            if (!isNaN(r) && !isNaN(a)) {
                this.picker.find(".datepicker-days .datepicker-switch").text(m.formatDate(o, g, this.o.language)), this.picker.find("tfoot .today").text(d).css("display", !0 === this.o.todayBtn || "linked" === this.o.todayBtn ? "table-cell" : "none"), this.picker.find("tfoot .clear").text(f).css("display", !0 === this.o.clearBtn ? "table-cell" : "none"), this.picker.find("thead .datepicker-title").text(this.o.title).css("display", "string" == typeof this.o.title && "" !== this.o.title ? "table-cell" : "none"), this.updateNavArrows(), this.fillMonths();
                var v = n(r, a, 0), y = v.getUTCDate();
                ...
                for (var _, w, D = []; v.valueOf() < b;) {
                    ...
                    var S = v.getUTCDate();
                    this.o.beforeShowDay !== t.noop && ((s = this.o.beforeShowDay(this._utc_to_local(v))) === e ? s = {} : "boolean" == typeof s ? s = {enabled: s} : "string" == typeof s && (s = {classes: s}), !1 === s.enabled && w.push("disabled"), s.classes && (w = w.concat(s.classes.split(/\s+/))), s.tooltip && (i = s.tooltip), s.content && (S = s.content)), w = t.isFunction(t.uniqueSort) ? t.uniqueSort(w) : t.unique(w), D.push('<td class="' + w.join(" ") + '"' + (i ? ' title="' + i + '"' : "") + ' data-date="' + v.getTime().toString() + '">' + S + "</td>"), i = null, _ === this.o.weekEnd && D.push("</tr>"), v.setUTCDate(v.getUTCDate() + 1)
                }
                ...
                if (t.each(this.dates, function (t, e) {
                    ...
                    var A = this;
                    t.each(M, function (n, i) {
                        var s = new Date(r, n, 1), o = A.o.beforeShowMonth(s);
                        o === e ? o = {} : "boolean" == typeof o ? o = {enabled: o} : "string" == typeof o && (o = {classes: o}), !1 !== o.enabled || t(i).hasClass("disabled") || t(i).addClass("disabled"), o.classes && t(i).addClass(o.classes), o.tooltip && t(i).prop("title", o.tooltip)
                    })
                }
                this._fill_yearsView(".datepicker-years", "year", 10, r, l, h, this.o.beforeShowYear), this._fill_yearsView(".datepicker-decades", "decade", 100, r, l, h, this.o.beforeShowDecade), this._fill_yearsView(".datepicker-centuries", "century", 1e3, r, l, h, this.o.beforeShowCentury)
            }
        },
        updateNavArrows: function () {
            if (this._allow_update) {
                var t, e, n = new Date(this.viewDate), i = n.getUTCFullYear(), s = n.getUTCMonth(),
                    o = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCFullYear() : -1 / 0,
                    r = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCMonth() : -1 / 0,
                    a = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCFullYear() : 1 / 0,
                    l = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCMonth() : 1 / 0, c = 1;
        ...
        dayCellClick: function (e) {
            var n = t(e.currentTarget).data("date"), i = new Date(n);
        ...
        moveMonth: function (t, e) {
            ...
            var n;
            if (!e) return t;
            var i, s, o = new Date(t.valueOf()), r = o.getUTCDate(), a = o.getUTCMonth(), l = Math.abs(e);
        ...
        keydown: function (t) {
            if (this.picker.is(":visible")) {
                var e, n, i = !1, s = this.focusDate || this.viewDate;
                switch (t.keyCode) {
                    case 27:
    ...
    var c = function (e, n) {
        ...
        }), delete n.inputs, this.keepEmptyValues = n.keepEmptyValues, delete n.keepEmptyValues, u.call(t(this.inputs), n).on("changeDate", t.proxy(this.dateUpdated, this)), this.pickers = t.map(this.inputs, function (e) {
    ...
    c.prototype = {
        ...
        dateUpdated: function (n) {
            if (!this.updating) {
                ...
                if (i !== e) {
                    var s = i.getUTCDate(), o = this.keepEmptyValues, r = t.inArray(n.target, this.inputs), a = r - 1,
                        l = r + 1, c = this.inputs.length;
                    if (-1 !== r) {
                        if (t.each(this.pickers, function (t, e) {
                            e.getUTCDate() || e !== i && o || e.setUTCDate(s)
                        }), s < this.dates[a]) for (; a >= 0 && s < this.dates[a];) this.pickers[a--].setUTCDate(s); else if (s > this.dates[l]) for (; l < c && s > this.dates[l];) this.pickers[l++].setUTCDate(s);
    ...
    var h = t.fn.datepicker, u = function (n) {
        var i, s = Array.apply(null, arguments);
        if (s.shift(), this.each(function () {
            var e = t(this), o = e.data("datepicker"), r = "object" == typeof n && n;
            if (!o) {
                var a = function (e, n) {
                    function i(t, e) {
                ...
                }(t.extend({}, d, a, r).language), u = t.extend({}, d, h, a, r);
                e.hasClass("input-daterange") || u.inputs ? (t.extend(u, {inputs: u.inputs || e.find("input").toArray()}), o = new c(this, u)) : o = new l(this, u), e.data("datepicker", o)
            }
    ...
    var p = t.fn.datepicker.dates = {
        ...
        parseDate: function (n, s, o, r) {
            function a() {
                var t = this.slice(0, c[d].length), e = c[d].slice(0, t.length);
            ...
            var c, h, u, d, f, g = {d: "moveDay", m: "moveMonth", w: "moveWeek", y: "moveYear"},
                v = {yesterday: "-1d", today: "+0d", tomorrow: "+1d"};
            if (n in v && (n = v[n]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(n)) {
                for (c = n.match(/([\-+]\d+)([dmwy])/gi), n = new Date, d = 0; d < c.length; d++) h = c[d].match(/([\-+]\d+)([dmwy])/i), u = Number(h[1]), f = g[h[2].toLowerCase()], n = l.prototype[f](n, u);
                return l.prototype._zero_utc_time(n)
            }
            c = n && n.match(this.nonpunctuation) || [];
            var y, b, _ = {}, w = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], D = {
                yyyy: function (t, e) {
            ...
            if (c.length !== k.length && (k = t(k).filter(function (e, n) {
                ...
                for (d = 0, C = k.length; d < C; d++) {
                    if (y = parseInt(c[d], 10), h = k[d], isNaN(y)) switch (h) {
                        case"MM":
                            b = t(p[o].months).filter(a), y = t.inArray(b[0], p[o].months) + 1;
                            break;
                        case"M":
                            b = t(p[o].monthsShort).filter(a), y = t.inArray(b[0], p[o].monthsShort) + 1
                    }
                    _[h] = y
                }
        ...
        formatDate: function (e, n, i) {
            ...
            for (var o = t.extend([], n.separators), r = 0, a = n.parts.length; r <= a; r++) o.length && e.push(o.shift()), e.push(s[n.parts[r]]);
            return e.join("")
        },
    ...
    e.prototype.init = function () {
        ...
        t(document).on("click", this.$portletCloser, function (n) {
            n.preventDefault();
            var i = t(this).closest(e.$portletIdentifier), s = i.parent();
    ...
    e.prototype.initSelect2 = function () {
        ...
        t('[data-toggle="input-mask"]').each(function (e, n) {
            var i = t(n).data("maskFormat"), s = t(n).data("reverse");
            null != s ? t(n).mask(i, {reverse: s}) : t(n).mask(i)
        })
        ...
        t('[data-toggle="date-picker-range"]').each(function (e, i) {
            var s = t.extend({}, n, t(i).data()), o = s.targetDisplay;
    ...
    e.prototype.send = function (e, n, i, s, o, r, a, l) {
        r || (r = 3e3), a || (a = 1);
        var c = {heading: e, text: n, position: i, loaderBg: s, icon: o, hideAfter: r, stack: a};
    ...
    e.prototype._resetSidebarScroll = function () {
        ...
        }), t(".side-nav").metisMenu(), this.$body.hasClass("scrollable-layout") && t("#left-side-menu-container").removeClass("slimscroll-menu"), e._resetSidebarScroll(), t(".right-bar-toggle").on("click", function (e) {
